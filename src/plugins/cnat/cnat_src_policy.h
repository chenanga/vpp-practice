...
typedef enum { CNAT_SPORT_PROTO_TCP, CNAT_SPORT_PROTO_UDP, CNAT_SPORT_PROTO_ICMP, CNAT_SPORT_PROTO_ICMP6, CNAT_N_SPORT_PROTO } cnat_sport_proto_t;
...
typedef cnat_source_policy_errors_t (*cnat_vip_source_policy_t)(vlib_main_t              *vm,
                                                                vlib_buffer_t            *b,
