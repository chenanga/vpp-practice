...
static inline void clib_bihash_mark_free_40_56(clib_bihash_kv_40_56_t *v)
{
    v->value[0] = 0xFEEDFACE8BADF00DULL;
}

static inline int clib_bihash_is_free_40_56(const clib_bihash_kv_40_56_t *v)
{
    if (v->value[0] == 0xFEEDFACE8BADF00DULL) return 1;
    return 0;
}

static inline u64 clib_bihash_hash_40_56(const clib_bihash_kv_40_56_t *v)
{
...
static inline u8 *format_bihash_kvp_40_56(u8 *s, va_list *args)
{
...
static inline int clib_bihash_key_compare_40_56(u64 *a, u64 *b)
{
