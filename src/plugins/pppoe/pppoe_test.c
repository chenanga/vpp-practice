...
static void vl_api_pppoe_add_del_session_reply_t_handler(vl_api_pppoe_add_del_session_reply_t *mp)
{
...
static int api_pppoe_add_del_session(vat_main_t *vam)
{
...
static void vl_api_pppoe_session_details_t_handler(vl_api_pppoe_session_details_t *mp)
{
    vat_main_t    *vam = &vat_main;
    ip46_address_t client_ip;
...
static int api_pppoe_session_dump(vat_main_t *vam)
{
...
static void vl_api_pppoe_add_del_cp_reply_t_handler(vl_api_pppoe_add_del_session_reply_t *mp)
{
    vat_main_t *vam    = &vat_main;
    i32         retval = ntohl(mp->retval);
    if (vam->async_mode) {
...
static int api_pppoe_add_del_cp(vat_main_t *vam)
{
    unformat_input_t          *line_input = vam->input;
