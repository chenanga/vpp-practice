      ...
      while (n_left_from >= 4 && n_left_to_next >= 2)
	{
	  ...
	  vlib_validate_buffer_enqueue_x2 (vm, node, next_index,
        ...
        while (n_left_from > 0 && n_left_to_next > 0) {
             ...
             */
            vlib_process_signal_event_mt(vm, dm->resolver_process_node_index, DNS_RESOLVER_EVENT_RESOLVED, (uword) resp0);
        ...
        done0:
            ...
            if (PREDICT_FALSE((node->flags & VLIB_NODE_FLAG_TRACE) && (b0->flags & VLIB_BUFFER_IS_TRACED))) {
                dns46_reply_trace_t *t = vlib_add_trace(vm, node, b0, sizeof(*t));
