...
#define elog_acl_cond_trace_X3(am, trace_cond, acl_elog_trace_format_label, acl_elog_trace_format_args, acl_elog_val1, acl_elog_val2, acl_elog_val3) \
    do {                                                                                                                                             \
        if (trace_cond) {                                                                                                                            \
            CLIB_UNUSED(struct { u8 available_space[18 - sizeof(acl_elog_val1) - sizeof(acl_elog_val2) - sizeof(acl_elog_val3)]; } * static_check);  \
            u16                   thread_index = os_get_thread_index();                                                                              \
            vlib_worker_thread_t* w            = vlib_worker_threads + thread_index;                                                                 \
            ELOG_TYPE_DECLARE(e)               = {                                                                                                   \
                              .format      = "(%02d) " acl_elog_trace_format_label,                                                                  \
...
#define elog_acl_cond_trace_X4(am,                                                                                                      \
    ...
    do {                                                                                                                                \
        if (trace_cond) {                                                                                                               \
            CLIB_UNUSED(struct {                                                                                                        \
                u8 available_space[18 - sizeof(acl_elog_val1) - sizeof(acl_elog_val2) - sizeof(acl_elog_val3) - sizeof(acl_elog_val4)]; \
            } * static_check);                                                                                                          \
            u16                   thread_index = os_get_thread_index();                                                                 \
            vlib_worker_thread_t* w            = vlib_worker_threads + thread_index;                                                    \
            ELOG_TYPE_DECLARE(e)               = {                                                                                      \
