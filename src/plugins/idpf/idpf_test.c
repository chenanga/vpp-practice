...
/* idpf create API */
static int api_idpf_create(vat_main_t *vam)
{
...
static void vl_api_idpf_create_reply_t_handler(vl_api_idpf_create_reply_t *mp)
{
...
/* idpf delete API */
static int api_idpf_delete(vat_main_t *vam)
{
    unformat_input_t     *i = vam->input;
