...
vnet_dev_rv_t oct_port_cfg_change(vlib_main_t *, vnet_dev_port_t *, vnet_dev_port_cfg_change_req_t *);
...
/* flow.c */
vnet_dev_rv_t oct_flow_ops_fn(vlib_main_t *, vnet_dev_port_t *, vnet_dev_port_cfg_type_t, u32, uword *);
vnet_dev_rv_t oct_flow_validate_params(vlib_main_t *, vnet_dev_port_t *, vnet_dev_port_cfg_type_t, u32, uword *);
vnet_dev_rv_t oct_flow_query(vlib_main_t *, vnet_dev_port_t *, u32, uword, u64 *);
...
vnet_dev_rv_t oct_rxq_get_stats(vlib_main_t *, vnet_dev_port_t *, vnet_dev_rx_queue_t *);
vnet_dev_rv_t oct_txq_get_stats(vlib_main_t *, vnet_dev_port_t *, vnet_dev_tx_queue_t *);

#define log_debug(dev, f, ...)  vlib_log(VLIB_LOG_LEVEL_DEBUG, oct_log.class, "%U: " f, format_vnet_dev_addr, (dev), ##__VA_ARGS__)
#define log_info(dev, f, ...)   vlib_log(VLIB_LOG_LEVEL_INFO, oct_log.class, "%U: " f, format_vnet_dev_addr, (dev), ##__VA_ARGS__)
#define log_notice(dev, f, ...) vlib_log(VLIB_LOG_LEVEL_NOTICE, oct_log.class, "%U: " f, format_vnet_dev_addr, (dev), ##__VA_ARGS__)
#define log_warn(dev, f, ...)   vlib_log(VLIB_LOG_LEVEL_WARNING, oct_log.class, "%U: " f, format_vnet_dev_addr, (dev), ##__VA_ARGS__)
#define log_err(dev, f, ...)    vlib_log(VLIB_LOG_LEVEL_ERR, oct_log.class, "%U: " f, format_vnet_dev_addr, (dev), ##__VA_ARGS__)
...
#define foreach_oct_tx_node_counter                                                                     \
    ...
    _(AURA_BATCH_ALLOC_ISSUE_FAIL, aura_batch_alloc_issue_fail, ERROR, "aura batch alloc issue failed") \
    _(AURA_BATCH_ALLOC_NOT_READY, aura_batch_alloc_not_ready, ERROR, "aura batch alloc not ready")      \
