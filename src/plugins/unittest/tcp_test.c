...
static int tcp_test_scoreboard_replay(vlib_main_t *vm, unformat_input_t *input)
{
    int              verbose = 0;
...
static int tcp_test_sack_rx(vlib_main_t *vm, unformat_input_t *input)
{
    tcp_connection_t        _tc, *tc = &_tc;
    ...
    if (verbose) vlib_cli_output(vm, "sb after even blocks (mss %u):\n%U", tc->snd_mss, format_tcp_scoreboard, sb, tc);

    TCP_TEST((pool_elts(sb->holes) == 5), "scoreboard has %d elements", pool_elts(sb->holes));

    /* First SACK block should be rejected */
    hole = scoreboard_first_hole(sb);
    TCP_TEST((hole->start == 0 && hole->end == 200), "first hole start %u end %u", hole->start, hole->end);
    hole = scoreboard_last_hole(sb);
    TCP_TEST((hole->start == 900 && hole->end == 1000), "last hole start %u end %u", hole->start, hole->end);
    TCP_TEST((sb->sacked_bytes == 400), "sacked bytes %d", sb->sacked_bytes);
    TCP_TEST((!sb->is_reneging), "is not reneging");
    TCP_TEST((sb->last_sacked_bytes == 400), "last sacked bytes %d", sb->last_sacked_bytes);
    ...
    if (verbose) vlib_cli_output(vm, "\nsb after odd blocks:\n%U", format_tcp_scoreboard, sb, tc);

    hole = scoreboard_first_hole(sb);
    TCP_TEST((pool_elts(sb->holes) == 2), "scoreboard has %d holes", pool_elts(sb->holes));
    TCP_TEST((hole->start == 0 && hole->end == 100), "first hole start %u end %u", hole->start, hole->end);
    ...
    TCP_TEST((pool_elts(sb->holes) == 1), "scoreboard has %d elements", pool_elts(sb->holes));
    TCP_TEST((sb->is_reneging), "is reneging");
    TCP_TEST((sb->last_sacked_bytes == 50), "last sacked bytes %d", sb->last_sacked_bytes);
    TCP_TEST((sb->rxt_sacked == 50), "last rxt sacked bytes %d", sb->rxt_sacked);
    ...
    TCP_TEST((sb->last_sacked_bytes == 0), "last sacked bytes %d", sb->last_sacked_bytes);
    ...
    TCP_TEST((sb->last_sacked_bytes == 20), "last sacked bytes %d", sb->last_sacked_bytes);
    TCP_TEST((sb->lost_bytes == 0), "lost bytes %u", sb->lost_bytes);
    TCP_TEST((!sb->is_reneging), "is not reneging");
    TCP_TEST((sb->rxt_sacked == 15), "last rxt sacked bytes %d", sb->rxt_sacked);
    ...
    TCP_TEST((sb->last_sacked_bytes == 1), "last sacked bytes %d", sb->last_sacked_bytes);
    TCP_TEST((sb->rxt_sacked == 11), "last rxt sacked bytes %d", sb->rxt_sacked);
    TCP_TEST((sb->last_bytes_delivered == 0), "last bytes delivered %d", sb->last_bytes_delivered);
    ...
    TCP_TEST((sb->last_sacked_bytes == 9), "last sacked bytes %d", sb->last_sacked_bytes);
    TCP_TEST((sb->rxt_sacked == 9), "last rxt sacked bytes %d", sb->rxt_sacked);
    ...
    TCP_TEST((sb->last_sacked_bytes == 10), "last sacked bytes %d", sb->last_sacked_bytes);
    TCP_TEST((sb->rxt_sacked == 0), "last rxt sacked bytes %d", sb->rxt_sacked);
    ...
    TCP_TEST((sb->sacked_bytes == 0), "sacked bytes %d", sb->sacked_bytes);
    TCP_TEST(sb->last_bytes_delivered == 30, "last bytes delivered %d", sb->last_bytes_delivered);
    TCP_TEST((sb->last_sacked_bytes == 0), "last sacked bytes %d", sb->last_sacked_bytes);
    TCP_TEST((sb->lost_bytes == 0), "lost bytes %u", sb->lost_bytes);
    TCP_TEST((!sb->is_reneging), "is not reneging");
    ...
    TCP_TEST((pool_elts(sb->holes) == 2), "scoreboard has %d holes", pool_elts(sb->holes));
    hole = scoreboard_first_hole(sb);
    TCP_TEST((hole->start == 1000 && hole->end == 1200), "first hole start %u end %u", hole->start, hole->end);
    TCP_TEST((sb->high_sacked == 1300), "max sacked byte %u", sb->high_sacked);
    hole = scoreboard_last_hole(sb);
    TCP_TEST((hole->start == 1300 && hole->end == 1500), "last hole start %u end %u", hole->start, hole->end);
    ...
    TCP_TEST((sb->sacked_bytes == 0), "sacked bytes %d", sb->sacked_bytes);
    TCP_TEST((pool_elts(sb->holes) == 1), "scoreboard has %d elements", pool_elts(sb->holes));
    TCP_TEST((sb->last_bytes_delivered == 100), "last bytes delivered %d", sb->last_bytes_delivered);
    TCP_TEST((sb->lost_bytes == 0), "lost bytes %u", sb->lost_bytes);
    ...
    TCP_TEST((pool_elts(sb->holes) == 0), "number of holes %d", pool_elts(sb->holes));
    TCP_TEST((sb->head == TCP_INVALID_SACK_HOLE_INDEX), "head %u", sb->head);
    TCP_TEST((sb->tail == TCP_INVALID_SACK_HOLE_INDEX), "tail %u", sb->tail);
    ...
    TCP_TEST((pool_elts(sb->holes) == 0), "scoreboard has %d elements", pool_elts(sb->holes));
    TCP_TEST((sb->is_reneging), "is reneging");
    ...
    TCP_TEST((sb->sacked_bytes == 0), "sacked bytes %d", sb->sacked_bytes);
    TCP_TEST((sb->last_sacked_bytes == 0), "last sacked bytes %d", sb->last_sacked_bytes);
    TCP_TEST((sb->last_bytes_delivered == 400), "last bytes delivered %d", sb->last_bytes_delivered);
    TCP_TEST((sb->lost_bytes == 0), "lost bytes %u", sb->lost_bytes);
    TCP_TEST((sb->head != TCP_INVALID_SACK_HOLE_INDEX), "head %u", sb->head);
    TCP_TEST((sb->tail != TCP_INVALID_SACK_HOLE_INDEX), "tail %u", sb->tail);
    ...
    TCP_TEST((sb->last_sacked_bytes == 500), "last sacked bytes %d", sb->last_sacked_bytes);
    ...
    TCP_TEST((pool_elts(sb->holes) == 2), "scoreboard has %d elements", pool_elts(sb->holes));
    TCP_TEST((sb->sacked_bytes == 600), "sacked bytes %d", sb->sacked_bytes);
    TCP_TEST((sb->last_sacked_bytes == 100), "last sacked bytes %d", sb->last_sacked_bytes);
    TCP_TEST((sb->last_bytes_delivered == 0), "last bytes delivered %d", sb->last_bytes_delivered);
    ...
    if (verbose) vlib_cli_output(vm, "\nAck high sacked:\n%U", format_tcp_scoreboard, sb, tc);
    TCP_TEST((sb->last_sacked_bytes == 0), "last sacked bytes %d", sb->last_sacked_bytes);
    TCP_TEST((sb->last_bytes_delivered == 500), "last bytes delivered %d", sb->last_bytes_delivered);
    TCP_TEST((!sb->is_reneging), "is not reneging");
    ...
    TCP_TEST((sb->last_sacked_bytes == 300), "last sacked bytes %d", sb->last_sacked_bytes);
    TCP_TEST((sb->last_bytes_delivered == 0), "last bytes delivered %d", sb->last_bytes_delivered);
    ...
    TCP_TEST((sb->last_sacked_bytes == 500), "last sacked bytes %d", sb->last_sacked_bytes);
    TCP_TEST(sb->is_reneging, "is reneging");
    TCP_TEST((sb->rxt_sacked == 300), "last rxt sacked bytes %d", sb->rxt_sacked);
...
static int tcp_test_sack_tx(vlib_main_t *vm, unformat_input_t *input)
{
    tcp_connection_t _tc, *tc = &_tc;
    sack_block_t    *sacks;
    ...
    TCP_TEST((vec_len(tc->snd_sacks) == 5), "sack blocks %d expected %d", vec_len(tc->snd_sacks), 5);
    TCP_TEST((tc->snd_sacks[0].start = 900), "first sack block start %u expected %u", tc->snd_sacks[0].start, 900);
    ...
    if (verbose) vlib_cli_output(vm, "add new segment [1100, 1200]\n%U", format_tcp_sacks, tc);
    expected = 5 < TCP_MAX_SACK_BLOCKS ? 6 : 5;
    TCP_TEST((vec_len(tc->snd_sacks) == expected), "sack blocks %d expected %d", vec_len(tc->snd_sacks), expected);
    TCP_TEST((tc->snd_sacks[0].start == 1100), "first sack block start %u expected %u", tc->snd_sacks[0].start, 1100);
    ...
    if (verbose) vlib_cli_output(vm, "overlap first 2 segments:\n%U", format_tcp_sacks, tc);
    TCP_TEST((vec_len(tc->snd_sacks) == 3), "sack blocks %d expected %d", vec_len(tc->snd_sacks), 3);
    TCP_TEST((tc->snd_sacks[0].start == 900), "first sack block start %u expected %u", tc->snd_sacks[0].start, 500);
    ...
    tcp_update_sack_list(tc, 1100, 1200);
    if (verbose) vlib_cli_output(vm, "add new segment [1100, 1200]\n%U", format_tcp_sacks, tc);
    TCP_TEST((vec_len(tc->snd_sacks) == 4), "sack blocks %d expected %d", vec_len(tc->snd_sacks), 4);
    TCP_TEST((tc->snd_sacks[0].start == 1100), "first sack block start %u expected %u", tc->snd_sacks[0].start, 1100);
    ...
    if (verbose) vlib_cli_output(vm, "join middle segments [800, 900]\n%U", format_tcp_sacks, tc);

    TCP_TEST((vec_len(tc->snd_sacks) == 3), "sack blocks %d expected %d", vec_len(tc->snd_sacks), 3);
    TCP_TEST((tc->snd_sacks[0].start == 700), "first sack block start %u expected %u", tc->snd_sacks[0].start, 1100);
    ...
    if (verbose) vlib_cli_output(vm, "advance rcv_nxt to 1200\n%U", format_tcp_sacks, tc);
    TCP_TEST((vec_len(tc->snd_sacks) == 0), "sack blocks %d expected %d", vec_len(tc->snd_sacks), 0);
    ...
    if (verbose) vlib_cli_output(vm, "add [100, 200] [300, 400]\n%U", format_tcp_sacks, tc);
    TCP_TEST((vec_len(tc->snd_sacks) == 2), "sack blocks %d expected %d", vec_len(tc->snd_sacks), 2);
    TCP_TEST((tc->snd_sacks[0].start == 300), "first sack block start %u expected %u", tc->snd_sacks[0].start, 300);

    tc->rcv_nxt = 100;
    tcp_update_sack_list(tc, 100, 100);
    if (verbose) vlib_cli_output(vm, "add [100, 200] rcv_nxt = 100\n%U", format_tcp_sacks, tc);
    TCP_TEST((vec_len(tc->snd_sacks) == 1), "sack blocks %d expected %d", vec_len(tc->snd_sacks), 1);
    TCP_TEST((tc->snd_sacks[0].start == 300), "first sack block start %u expected %u", tc->snd_sacks[0].start, 300);
    return 0;
}

static int tcp_test_sack(vlib_main_t *vm, unformat_input_t *input)
{
    int res = 0;
...
static int tcp_test_lookup(vlib_main_t *vm, unformat_input_t *input)
{
    ...
    tconn = session_lookup_connection_wt4(0, &tc1->lcl_ip.ip4, &tc1->rmt_ip.ip4, tc1->lcl_port, tc1->rmt_port, tc1->proto, 0, &is_filtered);
    ...
    TCP_TEST((tconn->lcl_port == tc1->lcl_port), "rmt port is identical %d", tconn->lcl_port == tc1->lcl_port);

    /*
     * Non-existing connection lookup should not work
     */

    tconn = session_lookup_connection_wt4(0, &tc2->lcl_ip.ip4, &tc2->rmt_ip.ip4, tc2->lcl_port, tc2->rmt_port, tc2->proto, 0, &is_filtered);
...
static int tcp_test_session(vlib_main_t *vm, unformat_input_t *input)
{
    int               rv = 0;
    ...
    if (is_add) {
        ...
        if (session_stream_accept(&tc0->connection, 0 /* listener index */, 0 /* thread index */, 0 /* notify */))
...
static inline int tbt_seq_lt(u32 a, u32 b)
{
    return seq_lt(a, b);
}

static void tcp_test_set_time(u32 thread_index, u32 val)
{
    session_main.wrk[thread_index].last_vlib_time = val;
    tcp_set_time_now(&tcp_main.wrk_ctx[thread_index], val);
}

static int tcp_test_delivery(vlib_main_t *vm, unformat_input_t *input)
{
    ...
    TCP_TEST(bts->min_seq == tc->snd_nxt - burst, "min seq should be snd_nxt prior to burst");
    ...
    TCP_TEST(tc->delivered == 3 * burst, "delivered should be 300 is %u", tc->delivered);
    ...
    TCP_TEST(tcp_bt_is_sane(bt), "tracker should be sane");
    TCP_TEST(pool_elts(bt->samples) == 7, "there should be 7 samples %u", pool_elts(bt->samples));
    TCP_TEST(tc->delivered_time == 8, "delivered time should be 8");
    TCP_TEST(tc->delivered == 3 * burst + 30, "delivered should be %u is %u", 3 * burst + 30, tc->delivered);
    /* All 3 samples have the same delivered number of bytes. So the first is
     * the reference for delivery estimate. */
    TCP_TEST(rs->interval_time == 4, "ack time should be 4 is %.2f", rs->interval_time);
    TCP_TEST(rs->delivered == 30, "delivered should be 30");
    TCP_TEST(rs->prior_delivered == 3 * burst, "sample delivered should be %u", 3 * burst);
    TCP_TEST(!(rs->flags & TCP_BTS_IS_RXT), "not retransmitted");
    ...
    TCP_TEST(tcp_bt_is_sane(bt), "tracker should be sane");
    TCP_TEST(pool_elts(bt->samples) == 6, "there should be 6 samples %u", pool_elts(bt->samples));

    /* Retransmit covers last sample entirely so it should be removed */
    tcp_bt_track_rxt(tc, snd_una + 2 * burst + 20, snd_una + 4 * burst);
    TCP_TEST(tcp_bt_is_sane(bt), "tracker should be sane");
    TCP_TEST(pool_elts(bt->samples) == 5, "there should be 5 samples %u", pool_elts(bt->samples));
    ...
    for (i = 0; i < vec_len(min_seqs); i++) {
        if (bts->min_seq != min_seqs[i]) TCP_TEST(0, "should be %u is %u", min_seqs[i], bts->min_seq);
        rbn = rb_tree_search_subtree_custom(&bt->sample_lookup, root, bts->min_seq, tbt_seq_lt);
        if (rbn->opaque != bts - bt->samples) TCP_TEST(0, "lookup should work");
    ...
    TCP_TEST(tcp_bt_is_sane(bt), "tracker should be sane");
    TCP_TEST(pool_elts(bt->samples) == 5, "num samples should be 5 is %u", pool_elts(bt->samples));
    TCP_TEST(tc->delivered_time == 10, "delivered time should be 10");
    TCP_TEST(tc->delivered == 5 * burst + 40, "delivered should be %u is %u", 5 * burst + 40, tc->delivered);
    ...
    TCP_TEST(rs->interval_time == 5, "ack time should be 5 is %.2f", rs->interval_time);
    /* delivered_now - delivered_rxt ~ 5 * burst + 40 - 3 * burst - 30 */
    TCP_TEST(rs->delivered == 2 * burst + 10, "delivered should be 210 is %u", rs->delivered);
    TCP_TEST(rs->prior_delivered == 3 * burst + 30, "sample delivered should be %u", 3 * burst + 30);
    ...
    TCP_TEST(tcp_bt_is_sane(bt), "tracker should be sane");
    TCP_TEST(pool_elts(bt->samples) == 0, "num samples should be 0 is %u", pool_elts(bt->samples));
    TCP_TEST(tc->delivered_time == 11, "delivered time should be 11");
    TCP_TEST(tc->delivered == 7 * burst, "delivered should be %u is %u", 7 * burst, tc->delivered);
    ...
    TCP_TEST(rs->delivered == 4 * burst - 30, "delivered should be 160 is %u", rs->delivered);
    TCP_TEST(rs->prior_delivered == 3 * burst + 30, "sample delivered should be %u", 3 * burst + 30);
    TCP_TEST(rs->flags & TCP_BTS_IS_RXT, "is retransmitted");
    TCP_TEST(rs->flags & TCP_BTS_IS_APP_LIMITED, "is app limited");
...
static int tcp_test_bt(vlib_main_t *vm, unformat_input_t *input)
{
    u32                 thread_index = 0;
    tcp_rate_sample_t   _rs = {0}, *rs = &_rs;
    tcp_connection_t    _tc, *tc       = &_tc;
...
static clib_error_t *tcp_test(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd_arg)
{
    int                           res  = 0;
    ...
    while (unformat_check_input(input) != UNFORMAT_END_OF_INPUT) {
        if (unformat(input, "sack")) {
            ...
            if ((res = tcp_test_sack(vm, input))) goto done;
            if ((res = tcp_test_lookup(vm, input))) goto done;
            if ((res = tcp_test_delivery(vm, input))) goto done;
        }
        else
            break;
    }
    ...
    if (res) return clib_error_return(0, "TCP unit test failed");
    return 0;
}
