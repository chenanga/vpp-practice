...
#define LACP_STEADY_STATE (LACP_STATE_SYNCHRONIZATION | LACP_STATE_COLLECTING | LACP_STATE_DISTRIBUTING)
...
typedef CLIB_PACKED(struct {
    u8                   subtype;
    u8                   version_number;
    lacp_actor_partner_t actor;
    lacp_actor_partner_t partner;
    lacp_collector_t     collector;
    lacp_terminator_t    terminator;
}) lacp_pdu_t;
