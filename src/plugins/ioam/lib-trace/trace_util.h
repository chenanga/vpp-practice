...
static inline u8 fetch_trace_data_size(u16 trace_type)
{
...
always_inline void ioam_trace_set_bit(ioam_trace_hdr_t *trace_hdr, u8 trace_bit)
{
    trace_hdr->ioam_trace_type |= trace_bit;
}

always_inline void ioam_trace_reset_bit(ioam_trace_hdr_t *trace_hdr, u8 trace_bit)
{
    trace_hdr->ioam_trace_type &= (~trace_bit);
}
