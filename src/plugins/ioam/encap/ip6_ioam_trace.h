...
always_inline void ip6_hbh_ioam_trace_set_bit(ioam_trace_option_t* trace, u8 trace_bit)
{
    ioam_trace_set_bit(&trace->trace_hdr, trace_bit);
}

always_inline void ip6_hbh_ioam_trace_reset_bit(ioam_trace_option_t* trace, u8 trace_bit)
{
