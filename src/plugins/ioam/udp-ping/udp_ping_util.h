 ...
 *
 */
always_inline void udp_ping_create_reply_from_probe_ip6(ip6_header_t *ip, ip6_hop_by_hop_header_t *hbh, udp_ping_t *udp)
{
    ip6_address_t        src;
    u16                  src_port;
    ...
    trace = (ioam_trace_option_t *) ip6_hbh_get_option(hbh, HBH_OPTION_TYPE_IOAM_TRACE_DATA_LIST);
