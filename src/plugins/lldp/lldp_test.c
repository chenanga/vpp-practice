...
static int api_lldp_config(vat_main_t *vam)
{
...
static int api_sw_interface_set_lldp(vat_main_t *vam)
{
    unformat_input_t               *i = vam->input;
...
static int api_lldp_dump(vat_main_t *vam)
{
    return 0;
}

static void vl_api_lldp_dump_reply_t_handler(vl_api_lldp_dump_reply_t *mp)
{
    // not yet implemented
}
