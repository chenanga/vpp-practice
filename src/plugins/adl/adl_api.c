 ...
 */
int vl_api_cop_interface_enable_disable_callback(u32 sw_if_index, int enable_disable)
{
    return adl_interface_enable_disable(sw_if_index, enable_disable);
}

static void vl_api_adl_interface_enable_disable_t_handler(vl_api_adl_interface_enable_disable_t *mp)
{
 ...
 * which will be deprecated in vpp 20.12.
 */
int vl_api_cop_whitelist_enable_disable_callback(adl_allowlist_enable_disable_args_t *a)
{
    return adl_allowlist_enable_disable(a);
}

static void vl_api_adl_allowlist_enable_disable_t_handler(vl_api_adl_allowlist_enable_disable_t *mp)
{
    adl_main_t                                  *am = &adl_main;
...
static clib_error_t *adl_api_init(vlib_main_t *vm)
{
    adl_main_t *am = &adl_main;
    am->vlib_main  = vm;
