...
static const u32 supported_flow_actions_intel =
    (VNET_FLOW_ACTION_MARK | VNET_FLOW_ACTION_REDIRECT_TO_NODE | VNET_FLOW_ACTION_REDIRECT_TO_QUEUE | VNET_FLOW_ACTION_BUFFER_ADVANCE
...
static dpdk_driver_t dpdk_drivers[] = {{
                                       ...
                                       {
                                           .drivers               = DPDK_DRIVERS({"net_liovf", "Cavium Lio VF"}, {"net_thunderx", "Cavium ThunderX"}),
                                           .interface_name_prefix = "VirtualFunctionEthernet",
                                       },
                                       {
                                           .drivers = DPDK_DRIVERS({"net_iavf", "Intel iAVF"}, {"net_i40e_vf", "Intel X710/XL710 Family VF"}),
                                           .interface_name_prefix  = "VirtualFunctionEthernet",
                                           .supported_flow_actions = supported_flow_actions_intel,
                                           .use_intel_phdr_cksum   = 1,
                                           .int_unmaskable         = 1,
                                       ...
                                       {
                                           .drivers = DPDK_DRIVERS({"mlx5_pci", "Mellanox ConnectX-4/5/6 Family"}, {"net_enic", "Cisco VIC"}),
                                           .use_intel_phdr_cksum = 1,
                                       },
                                       {
