...
vnet_dev_rv_t       ena_aq_create_sq(vlib_main_t *, vnet_dev_t *, ena_aq_create_sq_cmd_t *, ena_aq_create_sq_resp_t *);
vnet_dev_rv_t       ena_aq_create_cq(vlib_main_t *, vnet_dev_t *, ena_aq_create_cq_cmd_t *, ena_aq_create_cq_resp_t *);
vnet_dev_rv_t       ena_aq_destroy_sq(vlib_main_t *, vnet_dev_t *, ena_aq_destroy_sq_cmd_t *);
vnet_dev_rv_t       ena_aq_destroy_cq(vlib_main_t *, vnet_dev_t *, ena_aq_destroy_cq_cmd_t *);
vnet_dev_rv_t       ena_aq_set_feature(vlib_main_t *, vnet_dev_t *, ena_aq_feature_id_t, void *);
vnet_dev_rv_t       ena_aq_get_feature(vlib_main_t *, vnet_dev_t *, ena_aq_feature_id_t, void *);
vnet_dev_rv_t       ena_aq_get_stats(vlib_main_t *, vnet_dev_t *, ena_aq_stats_type_t, ena_aq_stats_scope_t, u16, void *);
...
vnet_dev_rv_t ena_port_cfg_change(vlib_main_t *, vnet_dev_port_t *, vnet_dev_port_cfg_change_req_t *);
vnet_dev_rv_t ena_port_cfg_change_validate(vlib_main_t *, vnet_dev_port_t *, vnet_dev_port_cfg_change_req_t *);
...
#define foreach_ena_rx_node_counter _(BUFFER_ALLOC, buffer_alloc, ERROR, "buffer alloc error")
...
#define log_debug(dev, f, ...) \
    vlib_log(VLIB_LOG_LEVEL_DEBUG, ena_log.class, "%U" f, format_vnet_dev_log, (dev), clib_string_skip_prefix(__func__, "ena_"), ##__VA_ARGS__)
#define log_info(dev, f, ...)   vlib_log(VLIB_LOG_LEVEL_INFO, ena_log.class, "%U: " f, format_vnet_dev_addr, (dev), ##__VA_ARGS__)
#define log_notice(dev, f, ...) vlib_log(VLIB_LOG_LEVEL_NOTICE, ena_log.class, "%U: " f, format_vnet_dev_addr, (dev), ##__VA_ARGS__)
#define log_warn(dev, f, ...)   vlib_log(VLIB_LOG_LEVEL_WARNING, ena_log.class, "%U: " f, format_vnet_dev_addr, (dev), ##__VA_ARGS__)
#define log_err(dev, f, ...)    vlib_log(VLIB_LOG_LEVEL_ERR, ena_log.class, "%U: " f, format_vnet_dev_addr, (dev), ##__VA_ARGS__)
