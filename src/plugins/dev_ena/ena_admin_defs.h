...
#define foreach_ena_aq_feature_id                                                    \
    ...
    _(5, 0, 1, 0, EXTRA_PROPERTIES_STRINGS, ena_aq_feat_extra_properties_strings_t)  \
    _(6, 0, 1, 0, EXTRA_PROPERTIES_FLAGS, ena_aq_feat_extra_properties_flags_t)      \
    _(7, 1, 1, 0, MAX_QUEUES_EXT, ena_aq_feat_max_queue_ext_t)                       \
    _(10, 0, 1, 1, RSS_HASH_FUNCTION, ena_aq_feat_rss_hash_function_t)               \
    _(11, 0, 1, 0, STATELESS_OFFLOAD_CONFIG, ena_aq_feat_stateless_offload_config_t) \
    _(12, 0, 1, 1, RSS_INDIRECTION_TABLE_CONFIG, ena_aq_feat_rss_ind_table_config_t) \
