...
static void vl_api_bpf_trace_filter_set_t_handler(vl_api_bpf_trace_filter_set_t *mp)
{
...
static void vl_api_bpf_trace_filter_set_v2_t_handler(vl_api_bpf_trace_filter_set_v2_t *mp)
{
    bpf_trace_filter_main_t                *bm = &bpf_trace_filter_main;
...
static clib_error_t *bpf_trace_filter_plugin_api_hookup(vlib_main_t *vm)
{
    bpf_trace_filter_main_t *bm = &bpf_trace_filter_main;
