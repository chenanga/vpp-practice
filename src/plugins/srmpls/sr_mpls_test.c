...
static int api_sr_mpls_policy_mod(vat_main_t *vam)
{
    return -1;
}

static int api_sr_mpls_steering_add_del(vat_main_t *vam)
{
    return -1;
}

static int api_sr_mpls_policy_assign_endpoint_color(vat_main_t *vam)
{
    return -1;
}

static int api_sr_mpls_policy_add(vat_main_t *vam)
{
...
static int api_sr_mpls_policy_del(vat_main_t *vam)
{
    unformat_input_t            *i = vam->input;
