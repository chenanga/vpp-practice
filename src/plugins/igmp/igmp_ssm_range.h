...
extern igmp_group_prefix_type_t igmp_group_prefix_get_type(const ip46_address_t *gaddr);

extern void igmp_group_prefix_set(const fib_prefix_t *pfx, igmp_group_prefix_type_t type);
