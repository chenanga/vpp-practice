...
extern void igmp_pkt_build_report_init(igmp_pkt_build_report_t *br, u32 sw_if_index);
...
extern void igmp_pkt_report_v3_add_group(igmp_pkt_build_report_t *br, const igmp_group_t *group, igmp_membership_group_v3_type_t type);
...
extern void igmp_pkt_build_query_init(igmp_pkt_build_query_t *bq, u32 sw_if_index);

extern void igmp_pkt_query_v3_add_group(igmp_pkt_build_query_t *bq, const igmp_group_t *group, const ip46_address_t *srcs);
