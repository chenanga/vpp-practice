...
STATIC_ASSERT(sizeof(wg_post_data_t) <= STRUCT_SIZE_OF(vnet_buffer_opaque_t, unused), "Custom meta-data too large for vnet_buffer_opaque_t");

#define wg_post_data(b) ((wg_post_data_t *) ((u8 *) ((b)->opaque) + STRUCT_OFFSET_OF(vnet_buffer_opaque_t, unused)))
