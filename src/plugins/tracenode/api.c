...
static void vl_api_tracenode_enable_disable_t_handler(vl_api_tracenode_enable_disable_t *mp)
{
    ...
    rv = tracenode_feature_enable_disable(ntohl(mp->sw_if_index), mp->is_pcap, mp->enable);
