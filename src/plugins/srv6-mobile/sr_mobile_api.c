...
static inline uint16_t sr_plugin_localsid_fn_num_find_by(ip6_sr_main_t *sm, const char *keyword_str, size_t keyword_len)
{
    ...
    vec_foreach (plugin_it, vec_plugins) {
        if (!srv6_mobile_strcmp_with_size(keyword_str, keyword_len, (char *) (*plugin_it)->keyword_str)) {
...
static inline uint16_t sr_plugin_policy_fn_num_find_by(ip6_sr_main_t *sm, const char *keyword_str, size_t keyword_len)
{
...
static void vl_api_sr_mobile_localsid_add_del_t_handler(vl_api_sr_mobile_localsid_add_del_t *mp)
{
    ...
    mobile_localsid_function_list_t            kind_fn       = SRV6_MOBILE_LOCALSID_UNKNOWN_FUNCTION;

    mp->behavior[sizeof(mp->behavior) - 1] = '\0';
    behavior_size                          = sizeof(mp->behavior);
    // search behavior index
    if (mp->behavior[0]) {
        if (!srv6_mobile_strcmp_with_size((char *) mp->behavior, behavior_size, "end.m.gtp4.e")) {
            kind_fn = SRV6_MOBILE_LOCALSID_END_M_GTP4_E;
        }
        else if (!srv6_mobile_strcmp_with_size((char *) mp->behavior, behavior_size, "end.m.gtp6.e")) {
            kind_fn = SRV6_MOBILE_LOCALSID_END_M_GTP6_E;
        }
        else if (!srv6_mobile_strcmp_with_size((char *) mp->behavior, behavior_size, "end.m.gtp6.d")) {
            kind_fn = SRV6_MOBILE_LOCALSID_END_M_GTP6_D;
        }
        else if (!srv6_mobile_strcmp_with_size((char *) mp->behavior, behavior_size, "end.m.gtp6.d.di")) {
            kind_fn = SRV6_MOBILE_LOCALSID_END_M_GTP6_D_DI;
        }
        else if (!srv6_mobile_strcmp_with_size((char *) mp->behavior, behavior_size, "end.m.gtp6.d.dt4")) {
            kind_fn = SRV6_MOBILE_LOCALSID_END_M_GTP6_D_DT4;
            dt_type = SRV6_GTP6_DT4;
        }
        else if (!srv6_mobile_strcmp_with_size((char *) mp->behavior, behavior_size, "end.m.gtp6.d.dt6")) {
            kind_fn = SRV6_MOBILE_LOCALSID_END_M_GTP6_D_DT6;
            dt_type = SRV6_GTP6_DT6;
        }
        else if (!srv6_mobile_strcmp_with_size((char *) mp->behavior, behavior_size, "end.m.gtp6.d.dt46")) {
        ...
        switch (kind_fn) {
            case SRV6_MOBILE_LOCALSID_END_M_GTP4_E:
                alloc_param_srv6_end_m_gtp4_e(&ls_plugin_mem, &mp->v4src_addr, ntohl(mp->v4src_position), ntohl(mp->fib_table));
                break;
            case SRV6_MOBILE_LOCALSID_END_M_GTP6_E:
                alloc_param_srv6_end_m_gtp6_e(&ls_plugin_mem, ntohl(mp->fib_table));
                break;
            case SRV6_MOBILE_LOCALSID_END_M_GTP6_D:
                alloc_param_srv6_end_m_gtp6_d(&ls_plugin_mem,
                                              &mp->sr_prefix.address,
                                              mp->sr_prefix.len,
                                              (u8) ntohl(mp->nhtype),
                                              mp->drop_in,
                                              ntohl(mp->fib_table));
            ...
            case SRV6_MOBILE_LOCALSID_END_M_GTP6_D_DI:
                alloc_param_srv6_end_m_gtp6_di(&ls_plugin_mem, &mp->sr_prefix.address, mp->sr_prefix.len, (u8) ntohl(mp->nhtype));
                break;
            ...
            case SRV6_MOBILE_LOCALSID_END_M_GTP6_D_DT46:
                alloc_param_srv6_end_m_gtp6_dt(&ls_plugin_mem, ntohl(mp->fib_table), ntohl(mp->local_fib_table), dt_type);
                break;
            case SRV6_MOBILE_LOCALSID_UNKNOWN_FUNCTION:
            default:
                return;  // error
        }
        behavior = sr_plugin_localsid_fn_num_find_by(sm, (char *) mp->behavior, behavior_size);
        if (behavior == UINT16_MAX) return;
    }
    else {
        return;
    }
...
static void vl_api_sr_mobile_policy_add_t_handler(vl_api_sr_mobile_policy_add_t *mp)
{
    ip6_sr_main_t                       *sm = &sr_main;
    ...
    // search behavior index
    if (mp->behavior[0]) {
        if (!srv6_mobile_strcmp_with_size((char *) mp->behavior, behavior_size, "t.m.gtp4.d")) {
            kind_fn = SRV6_MOBILE_POLICY_T_M_GTP4_D;
        }
        else if (!srv6_mobile_strcmp_with_size((char *) mp->behavior, behavior_size, "t.m.gtp4.dt4")) {
            kind_fn = SRV6_MOBILE_POLICY_T_M_GTP4_DT4;
            dt_type = SRV6_GTP4_DT4;
        }
        else if (!srv6_mobile_strcmp_with_size((char *) mp->behavior, behavior_size, "t.m.gtp4.dt6")) {
            kind_fn = SRV6_MOBILE_POLICY_T_M_GTP4_DT6;
            dt_type = SRV6_GTP4_DT6;
        }
        else if (!srv6_mobile_strcmp_with_size((char *) mp->behavior, behavior_size, "t.m.gtp4.dt46")) {
        ...
        switch (kind_fn) {
            case SRV6_MOBILE_POLICY_T_M_GTP4_D:
                alloc_param_srv6_t_m_gtp4_d(&ls_plugin_mem,
                                            &mp->v6src_prefix.address,
                                            mp->v6src_prefix.len,
                                            &mp->sr_prefix.address,
                                            mp->sr_prefix.len,
                                            ntohl(mp->fib_table),
            ...
            case SRV6_MOBILE_POLICY_T_M_GTP4_DT46:
                alloc_param_srv6_t_m_gtp4_dt(&ls_plugin_mem, ntohl(mp->fib_table), ntohl(mp->local_fib_table), dt_type);
                break;
        ...
        behavior = sr_plugin_policy_fn_num_find_by(sm, (char *) mp->behavior, behavior_size);
        if (behavior == UINT16_MAX) return;
    }
    else {
        return;
...
static clib_error_t *sr_mobile_api_hookup(vlib_main_t *vm)
{
    /*
