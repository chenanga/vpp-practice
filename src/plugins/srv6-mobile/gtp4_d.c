...
static u8 def_str[]     = "Transit function with decapsulation for IPv4/GTP tunnel";
static u8 param_str[] =
...
static uword clb_unformat_srv6_t_m_gtp4_d(unformat_input_t *input, va_list *args)
{
    ...
    alloc_param_srv6_t_m_gtp4_d(plugin_mem_p, &v6src_prefix, v6src_prefixlen, &sr_prefix, sr_prefixlen, fib_table, nhtype, drop_in);
...
static clib_error_t *srv6_t_m_gtp4_d_init(vlib_main_t *vm)
{
    ...
    if (rc < 0)
        clib_error_return(0,
                          "SRv6 Transit GTP4.D Policy function"
