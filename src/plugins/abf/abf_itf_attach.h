...
extern int abf_itf_attach(fib_protocol_t fproto, u32 policy_id, u32 priority, u32 sw_if_index);

extern int abf_itf_detach(fib_protocol_t fproto, u32 policy_id, u32 sw_if_index);
