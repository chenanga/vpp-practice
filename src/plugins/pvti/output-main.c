...
static u8 *format_pvti_output_trace(u8 *s, va_list *args)
{
    ...
    s = format(s, "PVTI-OUT(%d): sw_if_index %d, next index %d, underlay_mtu %d,", t->trace_type, t->sw_if_index, t->next_index, t->underlay_mtu);
    s = format(s,
