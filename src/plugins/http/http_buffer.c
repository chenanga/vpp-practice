...
static void buf_fifo_init(http_buffer_t *hb, void *data, u64 len)
{
...
static void buf_fifo_free(http_buffer_t *hb)
{
...
static svm_fifo_seg_t *buf_fifo_get_segs(http_buffer_t *hb, u32 max_len, u32 *n_segs)
{
    http_buffer_fifo_t *bf = (http_buffer_fifo_t *) &hb->data;
...
static u32 buf_fifo_drain(http_buffer_t *hb, u32 len)
{
    http_buffer_fifo_t *bf = (http_buffer_fifo_t *) &hb->data;
...
static u8 buf_fifo_is_drained(http_buffer_t *hb)
{
    http_buffer_fifo_t *bf = (http_buffer_fifo_t *) &hb->data;
...
static void buf_ptr_init(http_buffer_t *hb, void *data, u64 len)
{
    svm_fifo_t        *f = (svm_fifo_t *) data;
...
static void buf_ptr_free(http_buffer_t *hb)
{
...
static svm_fifo_seg_t *buf_ptr_get_segs(http_buffer_t *hb, u32 max_len, u32 *n_segs)
{
    http_buffer_ptr_t *bf = (http_buffer_ptr_t *) &hb->data;
...
static u32 buf_ptr_drain(http_buffer_t *hb, u32 len)
{
    http_buffer_ptr_t *bf = (http_buffer_ptr_t *) &hb->data;
...
static u8 buf_ptr_is_drained(http_buffer_t *hb)
{
    http_buffer_ptr_t *bf = (http_buffer_ptr_t *) &hb->data;
...
void http_buffer_init(http_buffer_t *hb, http_buffer_type_t type, svm_fifo_t *f, u64 data_len)
{
