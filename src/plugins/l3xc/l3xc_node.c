...
always_inline uword l3xc_input_inline(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *frame, fib_protocol_t fproto)
{
    ...
    while (n_left >= 8) {
        ...
        l3xci0 = *(u32 *) vnet_feature_next_with_data(&next_u32, b[0], sizeof(l3xci0));
        l3xci1 = *(u32 *) vnet_feature_next_with_data(&next_u32, b[1], sizeof(l3xci1));
        l3xci2 = *(u32 *) vnet_feature_next_with_data(&next_u32, b[2], sizeof(l3xci2));
        l3xci3 = *(u32 *) vnet_feature_next_with_data(&next_u32, b[3], sizeof(l3xci3));
