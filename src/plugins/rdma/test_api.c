...
static vl_api_rdma_mode_t api_rdma_mode(rdma_mode_t mode)
{
    switch (mode) {
        case RDMA_MODE_AUTO:
...
static vl_api_rdma_rss4_t api_rdma_rss4(rdma_rss4_t rss4)
{
    switch (rss4) {
        case RDMA_RSS4_AUTO:
...
static vl_api_rdma_rss6_t api_rdma_rss6(rdma_rss6_t rss6)
{
    switch (rss6) {
        case RDMA_RSS6_AUTO:
...
/* rdma create API */
static int api_rdma_create(vat_main_t *vam)
{
...
static int api_rdma_create_v2(vat_main_t *vam)
{
...
static int api_rdma_create_v3(vat_main_t *vam)
{
...
static int api_rdma_create_v4(vat_main_t *vam)
{
...
static void vl_api_rdma_create_reply_t_handler(vl_api_rdma_create_reply_t *mp)
{
...
/* rdma-create reply handler */
static void vl_api_rdma_create_v2_reply_t_handler(vl_api_rdma_create_v2_reply_t *mp)
{
    vat_main_t *vam    = rdma_test_main.vat_main;
    i32         retval = ntohl(mp->retval);
...
static void vl_api_rdma_create_v3_reply_t_handler(vl_api_rdma_create_v3_reply_t *mp)
{
    vat_main_t *vam    = rdma_test_main.vat_main;
    i32         retval = ntohl(mp->retval);
...
static void vl_api_rdma_create_v4_reply_t_handler(vl_api_rdma_create_v4_reply_t *mp)
{
    vat_main_t *vam    = rdma_test_main.vat_main;
...
/* rdma delete API */
static int api_rdma_delete(vat_main_t *vam)
{
