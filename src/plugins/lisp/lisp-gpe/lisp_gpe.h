...
typedef enum gpe_encap_mode_e { GPE_ENCAP_LISP, GPE_ENCAP_VXLAN, GPE_ENCAP_COUNT } gpe_encap_mode_t;
...
always_inline lisp_gpe_main_t *vnet_lisp_gpe_get_main()
{
...
extern u32  lisp_gpe_add_l3_iface(lisp_gpe_main_t *lgm, u32 vni, u32 bd_id, u8 with_default_route);
...
typedef enum { NO_ACTION, FORWARD_NATIVE, SEND_MAP_REQUEST, DROP } negative_fwd_actions_e;
