 ...
 */
always_inline u32 lisp_gpe_sub_interface_find_ip6(const ip6_address_t *addr, u32 vni)
{
    lisp_gpe_sub_interface_key_t key;
    const uword                 *p;
 ...
 *  Called from the data-plane
 */
always_inline index_t lisp_gpe_sub_interface_find_ip4(const ip4_address_t *addr, u32 vni)
{
    lisp_gpe_sub_interface_key_t key;
    const uword                 *p;
