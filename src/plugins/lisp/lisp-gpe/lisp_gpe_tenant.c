...
u32 lisp_gpe_tenant_l3_iface_add_or_lock(u32 vni, u32 table_id, u8 with_default_route)
{
    ...
    if (~0 == lt->lt_table_id) lt->lt_table_id = table_id;
    ...
    if (0 == lt->lt_locks[LISP_GPE_TENANT_LOCK_L3_IFACE]) {
        ...
        lt->lt_l3_sw_if_index = lisp_gpe_add_l3_iface(&lisp_gpe_main, vni, table_id, with_default_route);
    }
...
u32 lisp_gpe_tenant_l2_iface_add_or_lock(u32 vni, u32 bd_id)
{
    ...
    if (~0 == lt->lt_bd_id) lt->lt_bd_id = bd_id;
    ...
    if (0 == lt->lt_locks[LISP_GPE_TENANT_LOCK_L2_IFACE]) {
        ...
        lt->lt_l2_sw_if_index = lisp_gpe_add_l2_iface(&lisp_gpe_main, vni, bd_id);
    }
