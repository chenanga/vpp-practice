...
static int api_lisp_add_del_locator_set(vat_main_t *vam)
{
...
static int api_lisp_add_del_locator(vat_main_t *vam)
{
    unformat_input_t              *input = vam->input;
...
static int api_lisp_add_del_local_eid(vat_main_t *vam)
{
    unformat_input_t                *input = vam->input;
...
static int api_lisp_add_del_map_server(vat_main_t *vam)
{
    unformat_input_t                 *input = vam->input;
...
static int api_lisp_add_del_map_resolver(vat_main_t *vam)
{
    unformat_input_t                   *input = vam->input;
...
static int api_lisp_enable_disable(vat_main_t *vam)
{
    unformat_input_t             *input = vam->input;
 ...
 * @return return code
 */
static int api_lisp_pitr_set_locator_set(vat_main_t *vam)
{
    u8                                  ls_name_set = 0;
    unformat_input_t                   *input       = vam->input;
...
static int api_lisp_use_petr(vat_main_t *vam)
{
    unformat_input_t       *input = vam->input;
...
static void vl_api_show_lisp_use_petr_reply_t_handler(vl_api_show_lisp_use_petr_reply_t *mp)
{
...
static int api_show_lisp_use_petr(vat_main_t *vam)
{
...
static void vl_api_show_lisp_rloc_probe_state_reply_t_handler(vl_api_show_lisp_rloc_probe_state_reply_t *mp)
{
    vat_main_t *vam    = &vat_main;
...
static int api_show_lisp_map_register_state(vat_main_t *vam)
{
...
static int api_show_lisp_rloc_probe_state(vat_main_t *vam)
{
...
static int api_lisp_rloc_probe_enable_disable(vat_main_t *vam)
{
    unformat_input_t                        *input = vam->input;
...
static int api_lisp_map_register_enable_disable(vat_main_t *vam)
{
    unformat_input_t                          *input = vam->input;
...
static void vl_api_show_lisp_map_request_mode_reply_t_handler(vl_api_show_lisp_map_request_mode_reply_t *mp)
{
    vat_main_t *vam    = &vat_main;
    i32         retval = ntohl(mp->retval);

    if (0 <= retval) {
        print(vam->ofp, "map_request_mode: %s", mp->is_src_dst ? "src-dst" : "dst-only");
    }
...
static void vl_api_show_lisp_map_register_state_reply_t_handler(vl_api_show_lisp_map_register_state_reply_t *mp)
{
    vat_main_t *vam    = &vat_main;
    int         retval = clib_net_to_host_u32(mp->retval);
...
static void vl_api_lisp_locator_details_t_handler(vl_api_lisp_locator_details_t *mp)
{
    vat_main_t *vam = &vat_main;
    u8         *s   = 0;
...
static void vl_api_lisp_locator_set_details_t_handler(vl_api_lisp_locator_set_details_t *mp)
{
    vat_main_t *vam     = &vat_main;
    u8         *ls_name = 0;
...
static void vl_api_lisp_add_del_locator_set_reply_t_handler(vl_api_lisp_add_del_locator_set_reply_t *mp)
{
    vat_main_t *vam    = &vat_main;
    i32         retval = ntohl(mp->retval);
    if (vam->async_mode) {
...
static void vl_api_lisp_eid_table_details_t_handler(vl_api_lisp_eid_table_details_t *mp)
{
    vat_main_t *vam = &vat_main;
    u8         *s = 0, *eid = 0;
...
static void vl_api_lisp_eid_table_map_details_t_handler(vl_api_lisp_eid_table_map_details_t *mp)
{
    vat_main_t *vam = &vat_main;
...
static void vl_api_lisp_eid_table_vni_details_t_handler(vl_api_lisp_eid_table_vni_details_t *mp)
{
    vat_main_t *vam = &vat_main;
...
static void vl_api_lisp_adjacencies_get_reply_t_handler(vl_api_lisp_adjacencies_get_reply_t *mp)
{
    vat_main_t              *vam = &vat_main;
    u32                      i, n;
    int                      retval = clib_net_to_host_u32(mp->retval);
...
static void vl_api_lisp_map_server_details_t_handler(vl_api_lisp_map_server_details_t *mp)
{
    vat_main_t *vam = &vat_main;
...
static void vl_api_show_lisp_status_reply_t_handler(vl_api_show_lisp_status_reply_t *mp)
{
    vat_main_t *vam    = &vat_main;
    i32         retval = ntohl(mp->retval);

    if (0 <= retval) {
        print(vam->ofp, "feature: %s\ngpe: %s", mp->is_lisp_enabled ? "enabled" : "disabled", mp->is_gpe_enabled ? "enabled" : "disabled");
    }
...
static void vl_api_lisp_get_map_request_itr_rlocs_reply_t_handler(vl_api_lisp_get_map_request_itr_rlocs_reply_t *mp)
{
    vat_main_t *vam    = &vat_main;
    i32         retval = ntohl(mp->retval);
...
static void vl_api_show_lisp_pitr_reply_t_handler(vl_api_show_lisp_pitr_reply_t *mp)
{
    vat_main_t *vam    = &vat_main;
    i32         retval = ntohl(mp->retval);

    if (0 <= retval) {
        print(vam->ofp, "%-20s%-16s", mp->is_enabled ? "enabled" : "disabled", mp->is_enabled ? (char *) mp->locator_set_name : "");
    }
...
static int api_show_lisp_map_request_mode(vat_main_t *vam)
{
...
static int api_lisp_map_request_mode(vat_main_t *vam)
{
    unformat_input_t               *input = vam->input;
...
static int api_show_lisp_pitr(vat_main_t *vam)
{
 ...
 */
static int api_lisp_eid_table_add_del_map(vat_main_t *vam)
{
    unformat_input_t                    *input = vam->input;
 ...
 * @return return code
 */
static int api_lisp_add_del_remote_mapping(vat_main_t *vam)
{
    unformat_input_t                     *input = vam->input;
 ...
 * @return return code
 */
static int api_lisp_add_del_adjacency(vat_main_t *vam)
{
    unformat_input_t                *input = vam->input;
 ...
 * @return return code
 */
static int api_lisp_add_del_map_request_itr_rlocs(vat_main_t *vam)
{
    unformat_input_t                            *input = vam->input;
...
static int api_lisp_locator_dump(vat_main_t *vam)
{
    unformat_input_t           *input = vam->input;
    ...
    if (!lisp_test_main.ping_id) lisp_test_main.ping_id = vl_msg_api_get_msg_index((u8 *) (VL_API_CONTROL_PING_CRC));
    mp_ping               = vl_msg_api_alloc_as_if_client(sizeof(*mp_ping));
...
static int api_lisp_locator_set_dump(vat_main_t *vam)
{
...
static int api_lisp_eid_table_map_dump(vat_main_t *vam)
{
    u8                                is_l2    = 0;
    u8                                mode_set = 0;
    unformat_input_t                 *input    = vam->input;
...
static int api_lisp_eid_table_vni_dump(vat_main_t *vam)
{
...
static int api_lisp_eid_table_dump(vat_main_t *vam)
{
...
static int api_lisp_adjacencies_get(vat_main_t *vam)
{
    unformat_input_t              *i = vam->input;
...
static int api_lisp_map_server_dump(vat_main_t *vam)
{
...
static int api_lisp_map_resolver_dump(vat_main_t *vam)
{
...
static int api_show_lisp_status(vat_main_t *vam)
{
...
static int api_lisp_get_map_request_itr_rlocs(vat_main_t *vam)
{
