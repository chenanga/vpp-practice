...
typedef enum { IP4_MISS_PACKET, IP6_MISS_PACKET } miss_packet_type_t;
...
typedef enum { MR_MODE_DST_ONLY = 0, MR_MODE_SRC_DST, _MR_MODE_MAX } map_request_mode_t;
...
typedef enum { LISP_TRANSPORT_PROTOCOL_UDP = 1, LISP_TRANSPORT_PROTOCOL_API } lisp_transport_protocol_t;
...
always_inline mapping_t *lisp_get_petr_mapping(lisp_cp_main_t *lcm)
{
