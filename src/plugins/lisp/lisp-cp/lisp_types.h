...
typedef enum { HMAC_NO_KEY = 0, HMAC_SHA_1_96, HMAC_SHA_256_128 } lisp_key_type_t;
...
typedef enum fid_addr_type_t_ { FID_ADDR_IP_PREF, FID_ADDR_MAC, FID_ADDR_NSH } __attribute__((packed)) fid_addr_type_t;
...
/* LISP AFI codes  */
typedef enum { LISP_AFI_NO_ADDR, LISP_AFI_IP, LISP_AFI_IP6, LISP_AFI_LCAF = 16387, LISP_AFI_MAC = 16389 } lisp_afi_e;
