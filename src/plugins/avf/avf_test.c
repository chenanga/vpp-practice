...
/* avf create API */
static int api_avf_create(vat_main_t *vam)
{
...
static void vl_api_avf_create_reply_t_handler(vl_api_avf_create_reply_t *mp)
{
...
/* avf delete API */
static int api_avf_delete(vat_main_t *vam)
{
    unformat_input_t    *i = vam->input;
