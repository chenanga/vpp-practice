...
always_inline void nat_6t_flow_saddr_rewrite_set(nat_6t_flow_t *f, u32 saddr)
{
    f->ops |= NAT_FLOW_OP_SADDR_REWRITE;
    f->rewrite.saddr.as_u32 = saddr;
}

always_inline void nat_6t_flow_daddr_rewrite_set(nat_6t_flow_t *f, u32 daddr)
{
    f->ops |= NAT_FLOW_OP_DADDR_REWRITE;
    f->rewrite.daddr.as_u32 = daddr;
}

always_inline void nat_6t_flow_sport_rewrite_set(nat_6t_flow_t *f, u32 sport)
{
    f->ops |= NAT_FLOW_OP_SPORT_REWRITE;
    f->rewrite.sport = sport;
}

always_inline void nat_6t_flow_dport_rewrite_set(nat_6t_flow_t *f, u32 dport)
{
    f->ops |= NAT_FLOW_OP_DPORT_REWRITE;
    f->rewrite.dport = dport;
}

always_inline void nat_6t_flow_txfib_rewrite_set(nat_6t_flow_t *f, u32 tx_fib_index)
{
    f->ops |= NAT_FLOW_OP_TXFIB_REWRITE;
    f->rewrite.fib_index = tx_fib_index;
}

always_inline void nat_6t_flow_icmp_id_rewrite_set(nat_6t_flow_t *f, u16 id)
{
...
#undef _
     ...
     */
    nat44_ed_tcp_state_e tcp_state_change_table[NAT44_ED_TCP_N_STATE][NAT44_ED_N_DIR][NAT44_ED_TCP_N_FLAG];
} snat_main_t;
...
*/
always_inline bool nat44_ed_is_session_static(snat_session_t *s)
{
...
*/
always_inline bool nat44_ed_is_twice_nat_session(snat_session_t *s)
{
...
*/
always_inline bool nat44_ed_is_lb_session(snat_session_t *s)
{
...
/** \brief Check if NAT session is forwarding bypass.
    ...
    @return true if NAT session is load-balancing
*/
always_inline bool na44_ed_is_fwd_bypass_session(snat_session_t *s)
{
...
*/
always_inline bool nat44_ed_is_affinity_session(snat_session_t *s)
{
...
*/
always_inline bool nat44_ed_is_exact_address_session(snat_session_t *s)
{
...
*/
always_inline bool nat44_ed_is_interface_inside(snat_interface_t *i)
{
...
*/
always_inline bool nat44_ed_is_interface_outside(snat_interface_t *i)
{
...
*/
always_inline bool tcp_flags_is_init(u8 f)
{
    return (f & TCP_FLAG_SYN) && !(f & TCP_FLAG_ACK);
}

always_inline bool is_sm_addr_only(u32 f)
{
    return (f & NAT_SM_FLAG_ADDR_ONLY);
}

always_inline bool is_sm_out2in_only(u32 f)
{
    return (f & NAT_SM_FLAG_OUT2IN_ONLY);
}

always_inline bool is_sm_identity_nat(u32 f)
{
    return (f & NAT_SM_FLAG_IDENTITY_NAT);
}

always_inline bool is_sm_lb(u32 f)
{
    return (f & NAT_SM_FLAG_LB);
}

always_inline bool is_sm_exact_address(u32 f)
{
    return (f & NAT_SM_FLAG_EXACT_ADDRESS);
}

always_inline bool is_sm_self_twice_nat(u32 f)
{
    return (f & NAT_SM_FLAG_SELF_TWICE_NAT);
}

always_inline bool is_sm_twice_nat(u32 f)
{
    return (f & NAT_SM_FLAG_TWICE_NAT);
}

always_inline bool is_sm_switch_address(u32 f)
{
