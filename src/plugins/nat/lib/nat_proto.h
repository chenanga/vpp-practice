...
always_inline nat_protocol_t ip_proto_to_nat_proto(ip_protocol_t ip_proto)
{
...
static_always_inline ip_protocol_t nat_proto_to_ip_proto(nat_protocol_t nat_proto)
{
    ...
    ASSERT(NAT_PROTOCOL_OTHER == nat_proto || NAT_PROTOCOL_TCP == nat_proto || NAT_PROTOCOL_UDP == nat_proto || NAT_PROTOCOL_ICMP == nat_proto);
