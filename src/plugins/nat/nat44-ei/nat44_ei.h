...
typedef int(nat44_ei_alloc_out_addr_and_port_function_t)(nat44_ei_address_t *addresses,
                                                         u32                 fib_index,
                                                         u32                 thread_index,
...
always_inline bool nat44_ei_is_session_static(nat44_ei_session_t *s)
{
    return (s->flags & NAT44_EI_SESSION_FLAG_STATIC_MAPPING);
}

always_inline bool nat44_ei_is_unk_proto_session(nat44_ei_session_t *s)
{
    return (s->flags & NAT44_EI_SESSION_FLAG_UNKNOWN_PROTO);
}

always_inline bool nat44_ei_interface_is_inside(nat44_ei_interface_t *i)
{
    return (i->flags & NAT44_EI_INTERFACE_FLAG_IS_INSIDE);
}

always_inline bool nat44_ei_interface_is_outside(nat44_ei_interface_t *i)
{
