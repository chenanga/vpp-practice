...
static int api_nsim_cross_connect_enable_disable(vat_main_t *vam)
{
...
static int api_nsim_output_feature_enable_disable(vat_main_t *vam)
{
    unformat_input_t                            *i              = vam->input;
    int                                          enable_disable = 1;
    u32                                          sw_if_index    = ~0;
...
static int api_nsim_configure(vat_main_t *vam)
{
    ...
    mp->bandwidth_in_bits_per_second = clib_host_to_net_u64(mp->bandwidth_in_bits_per_second);
...
static int api_nsim_configure2(vat_main_t *vam)
{
