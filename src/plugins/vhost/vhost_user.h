...
#define VHOST_USER_PROTOCOL_FEATURES ((1ULL << VHOST_USER_PROTOCOL_F_MQ) | (1ULL << VHOST_USER_PROTOCOL_F_LOG_SHMFD))

#define vu_log_debug(dev, f, ...)              \
    {                                          \
        vlib_log(VLIB_LOG_LEVEL_DEBUG,         \
                 vhost_user_main.log_default,  \
                 "%U: " f,                     \
...
#define UNIX_GET_FD(unixfd_idx)                                                                            \
    ({                                                                                                     \
        ...
        (__unixfd_idx != ~0) ? pool_elt_at_index(file_main.file_pool, __unixfd_idx)->file_descriptor : -1; \
    })
...
#define FEATURE_VIRTIO_NET_F_HOST_TSO_FEATURE_BITS                                                                      \
    (VIRTIO_FEATURE(VIRTIO_NET_F_CSUM) | VIRTIO_FEATURE(VIRTIO_NET_F_HOST_UFO) | VIRTIO_FEATURE(VIRTIO_NET_F_HOST_TSO4) \
     | VIRTIO_FEATURE(VIRTIO_NET_F_HOST_TSO6))

#define FEATURE_VIRTIO_NET_F_GUEST_TSO_FEATURE_BITS                                                                             \
    (VIRTIO_FEATURE(VIRTIO_NET_F_GUEST_CSUM) | VIRTIO_FEATURE(VIRTIO_NET_F_GUEST_UFO) | VIRTIO_FEATURE(VIRTIO_NET_F_GUEST_TSO4) \
     | VIRTIO_FEATURE(VIRTIO_NET_F_GUEST_TSO6))

#define FEATURE_VIRTIO_NET_F_HOST_GUEST_TSO_FEATURE_BITS (FEATURE_VIRTIO_NET_F_HOST_TSO_FEATURE_BITS | FEATURE_VIRTIO_NET_F_GUEST_TSO_FEATURE_BITS)
