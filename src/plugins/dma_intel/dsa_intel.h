...
enum dsa_ops { INTEL_DSA_OP_NOP = 0, INTEL_DSA_OP_BATCH, INTEL_DSA_OP_DRAIN, INTEL_DSA_OP_MEMMOVE, INTEL_DSA_OP_FILL };
...
#define dsa_log_debug(f, ...) vlib_log(VLIB_LOG_LEVEL_DEBUG, intel_dsa_log.class, "%s: " f, __func__, ##__VA_ARGS__)

#define dsa_log_info(f, ...) vlib_log(VLIB_LOG_LEVEL_INFO, intel_dsa_log.class, "%s: " f, __func__, ##__VA_ARGS__)

#define dsa_log_error(f, ...) vlib_log(VLIB_LOG_LEVEL_ERR, intel_dsa_log.class, "%s: " f, __func__, ##__VA_ARGS__)
