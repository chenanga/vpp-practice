...
#define VNET_DHCP6_PD_REPLY_EVENT_FUNCTION(f)                                                                                            \
                                                                                                                                         \
    static void __vnet_dhcp6_pd_reply_event_function_init_##f(void) __attribute__((__constructor__));                                    \
                                                                                                                                         \
    ...
    {                                                                                                                                    \
        ...
        init_function.fp                                 = (void *) &f;                                                                  \
                                                                                                                                         ...
                                                                                                                                         \
    static void __vnet_dhcp6_pd_reply_event_function_deinit_##f(void) __attribute__((__destructor__));                                   \
                                                                                                                                         \
    ...
    {                                                                                                                                    \
        ...
        while (next->next_dhcp6_pd_reply_event_function) {                                                                               \
            if (next->next_dhcp6_pd_reply_event_function->fp == (void *) &f) {                                                           \
                next->next_dhcp6_pd_reply_event_function = next->next_dhcp6_pd_reply_event_function->next_dhcp6_pd_reply_event_function; \
                return;                                                                                                                  \
            }                                                                                                                            \
