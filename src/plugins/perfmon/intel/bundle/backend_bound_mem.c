...
static u8 *format_intel_backend_bound_mem(u8 *s, va_list *args)
{
...
PERFMON_REGISTER_BUNDLE(intel_core_backend_bound_mem) = {
    .name = "td-backend-mem",
    .description =
        "Topdown BackEnd-bound Memory - % cycles not retiring "
    ...
    .column_headers = PERFMON_STRINGS("Clocks/Packet", "%Store Bound", "%L1 Bound", "%FB Full", "%L2 Bound", "%L3 Bound", "%DRAM Bound"),
};
