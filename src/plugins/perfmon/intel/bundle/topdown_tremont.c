...
static int is_tremont()
{
    return clib_cpu_supports_movdir64b() && !clib_cpu_supports_avx2();
}

static perfmon_cpu_supports_t topdown_lvl1_cpu_supports[] = {{is_tremont, PERFMON_BUNDLE_TYPE_THREAD}};
...
PERFMON_REGISTER_BUNDLE(topdown_lvl1_tremont) = {
    ...
    .column_headers = PERFMON_STRINGS("% NS", "% ST", "% NS.RT", "% NS.BS", "% ST.FE", "% ST.BE"),
    .footer =
