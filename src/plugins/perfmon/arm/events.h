...
#define foreach_perf_arm_event                                                                    \
    ...
    _(0x10, BR_MIS_PRED, "Mispredicted or not predicted branch Speculatively executed")           \
    _(0x22, BR_MIS_PRED_RETIRED, "Instruction architecturally executed, mispredicted branch")     \
    ...
    _(0x34, DTLB_WALK, "Access to data or unified TLB causes a translation table walk")           \
    _(0x0A,                                                                                       \
      EXC_RETURN,                                                                                 \
    ...
    _(0x35, ITLB_WALK, "Access to instruction TLB that causes a translation table walk")          \
    _(0x04, L1D_CACHE, "Level 1 data cache access")                                               \
    _(0x1F, L1D_CACHE_ALLOCATE, "Level 1 data cache allocation without refill")                   \
    ...
    _(0x20, L2D_CACHE_ALLOCATE, "Level 2 data cache allocation without refill")                   \
    ...
    _(0x29, L3D_CACHE_ALLOCATE, "Level 3 data cache allocation without refill")                   \
    ...
    _(0x31, REMOTE_ACCESS, "Access to another socket in a multi-socket system")                   \
    _(0x38, REMOTE_ACCESS_RD, "Access to another socket in a multi-socket system, read")          \
    ...
    _(0x3D, STALL_SLOT_BACKEND, "No operation sent for execution on a Slot due to the backend")   \
    _(0x3E, STALL_SLOT_FRONTEND, "No operation sent for execution on a Slot due to the frontend") \
    _(0x07,                                                                                       \
      ST_RETIRED,                                                                                 \
