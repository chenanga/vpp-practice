                                ...
                                u8             flags)
{
    ...
    if (ea_bits_len > 0 && (ip6_prefix_len + ea_bits_len) > 64) return NULL;
    ...
    if (ip6_prefix_len + suffix_len + d->psid_length > 64) return NULL;
...
static void test_map_eabits(void)
{
    ...
    map_domain_t* d      = get_domain(&ip4_prefix, 16, &ip6_prefix, 48, &ip6_src, 128, 16, 6, 8, 0, 0);
    assert(!d);

    // 20.0.0.0/8	2001:db8::/32	4	2001:db8:a000::14a0:0:0
    d              = get_domain(&ip4_prefix, 8, &ip6_prefix, 32, &ip6_src, 128, 4, 0, 0, 0, 0);
    dst6.as_u64[0] = map_get_pfx(d, 0x14a9c9db, 1232);
    dst6.as_u64[1] = map_get_sfx(d, 0x14a9c9db, 1232);
    ...
    d              = get_domain(&ip4_prefix, 8, &ip6_prefix, 32, &ip6_src, 128, 8, 0, 0, 0, 0);
    dst6.as_u64[0] = map_get_pfx(d, 0x14a9c9db, 1232);
    dst6.as_u64[1] = map_get_sfx(d, 0x14a9c9db, 1232);
    ...
    d              = get_domain(&ip4_prefix, 8, &ip6_prefix, 32, &ip6_src, 128, 10, 0, 0, 0, 0);
    dst6.as_u64[0] = map_get_pfx(d, 0x14a9c9db, 1232);
    dst6.as_u64[1] = map_get_sfx(d, 0x14a9c9db, 1232);
    ...
    d              = get_domain(&ip4_prefix, 8, &ip6_prefix, 32, &ip6_src, 128, 16, 0, 0, 0, 0);
    dst6.as_u64[0] = map_get_pfx(d, 0x14a9c9db, 1232);
    dst6.as_u64[1] = map_get_sfx(d, 0x14a9c9db, 1232);
    ...
    d              = get_domain(&ip4_prefix, 8, &ip6_prefix, 32, &ip6_src, 128, 20, 0, 0, 0, 0);
    dst6.as_u64[0] = map_get_pfx(d, 0x14a9c9db, 1232);
    dst6.as_u64[1] = map_get_sfx(d, 0x14a9c9db, 1232);
    ...
    d              = get_domain(&ip4_prefix, 8, &ip6_prefix, 32, &ip6_src, 128, 23, 0, 0, 0, 0);
    dst6.as_u64[0] = map_get_pfx(d, 0x14a9c9db, 1232);
    dst6.as_u64[1] = map_get_sfx(d, 0x14a9c9db, 1232);
    ...
    d              = get_domain(&ip4_prefix, 8, &ip6_prefix, 32, &ip6_src, 128, 7, 0, 0, 0, 0);
    dst6.as_u64[0] = map_get_pfx(d, 0x14a9c9db, 1232);
    dst6.as_u64[1] = map_get_sfx(d, 0x14a9c9db, 1232);
...
{
#define _(_test_name) test_##_test_name();
