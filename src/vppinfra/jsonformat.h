...
CJSON_PUBLIC(int)
vl_api_ip4_address_t_fromjson(void **mp, int *len, cJSON *o, vl_api_ip4_address_t *a);
CJSON_PUBLIC(int)
vl_api_ip4_prefix_t_fromjson(void **mp, int *len, cJSON *o, vl_api_ip4_prefix_t *a);
CJSON_PUBLIC(int)
vl_api_ip4_address_with_prefix_t_fromjson(void **mp, int *len, cJSON *o, vl_api_ip4_prefix_t *a);
CJSON_PUBLIC(int)
vl_api_ip6_address_t_fromjson(void **mp, int *len, cJSON *o, vl_api_ip6_address_t *a);
CJSON_PUBLIC(int)
vl_api_ip6_prefix_t_fromjson(void **mp, int *len, cJSON *o, vl_api_ip6_prefix_t *a);
CJSON_PUBLIC(int)
vl_api_ip6_address_with_prefix_t_fromjson(void **mp, int *len, cJSON *o, vl_api_ip6_prefix_t *a);
CJSON_PUBLIC(int)
...
CJSON_PUBLIC(int)
vl_api_address_with_prefix_t_fromjson(void **mp, int *len, cJSON *o, vl_api_prefix_t *a);
CJSON_PUBLIC(int)
vl_api_mac_address_t_fromjson(void **mp, int *len, cJSON *o, vl_api_mac_address_t *a);
...
CJSON_PUBLIC(cJSON *) vl_api_ip4_address_with_prefix_t_tojson(vl_api_ip4_prefix_t *a);
CJSON_PUBLIC(cJSON *)
