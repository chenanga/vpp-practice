...
static_always_inline void clib_index_to_ptr_u32x4(u32 *indices, void **ptrs, i32 i, u64x2 ov, u8 shift)
{
...
static_always_inline void clib_index_to_ptr_u32(u32 *indices, void *base, u8 shift, void **ptrs, u32 n_elts)
{
    ...
    if (n_elts >= 4) {
        ...
        if (n > 4) clib_index_to_ptr_u32x4(indices, ptrs, 0, ov, shift);
