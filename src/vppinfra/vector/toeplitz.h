...
static_always_inline u32x8 toeplitz_hash_one_x8(u32x8 hash, u64x4 v4, u8 data, u8 off)
{
    u32x8 v8 = u32x8_shuffle2(v4 << (off * 8),
                              v4 << (off * 8 + 4),
...
static_always_inline u64x8 clib_toeplitz_hash_gfni_one(u8x64 d0, u64x8 m, int i)
{
...
static_always_inline u64x8 clib_toeplitz_hash_gfni_two(u8x64 d0, u8x64 d1, u64x8 m, int i)
{
    d0 = i == 1 ? (u8x64) u64x8_align_right(d0, d0, 1) : d0;
...
static_always_inline u32 clib_toeplitz_hash(clib_toeplitz_hash_key_t *k, u8 *data, int n_bytes)
{
    u8 *key = k->data;
...
next56:
    h0 = u64x8_xor3(h0, clib_toeplitz_hash_gfni_one(d0, m[0], 0), clib_toeplitz_hash_gfni_one(d0, m[1], 1));
    h0 = u64x8_xor3(h0, clib_toeplitz_hash_gfni_one(d0, m[2], 2), clib_toeplitz_hash_gfni_one(d0, m[3], 3));
    h0 = u64x8_xor3(h0, clib_toeplitz_hash_gfni_one(d0, m[4], 4), clib_toeplitz_hash_gfni_one(d0, m[5], 5));
...
static_always_inline void clib_toeplitz_hash_x4(clib_toeplitz_hash_key_t *k,
                                                u8                       *data0,
                                                u8                       *data1,
                                                u8                       *data2,
                                                u8                       *data3,
                                                ...
                                                int                       n_bytes)
{
    ...
    d3   = u8x64_mask_load_zero((u8 *) data3, mask);
next56:
    h0 = u64x8_xor3(h0, clib_toeplitz_hash_gfni_two(d0, d1, m[0], 0), clib_toeplitz_hash_gfni_two(d0, d1, m[1], 1));
    h2 = u64x8_xor3(h2, clib_toeplitz_hash_gfni_two(d2, d3, m[0], 0), clib_toeplitz_hash_gfni_two(d2, d3, m[1], 1));

    h0 = u64x8_xor3(h0, clib_toeplitz_hash_gfni_two(d0, d1, m[2], 2), clib_toeplitz_hash_gfni_two(d0, d1, m[3], 3));
    h2 = u64x8_xor3(h2, clib_toeplitz_hash_gfni_two(d2, d3, m[2], 2), clib_toeplitz_hash_gfni_two(d2, d3, m[3], 3));

    h0 = u64x8_xor3(h0, clib_toeplitz_hash_gfni_two(d0, d1, m[4], 4), clib_toeplitz_hash_gfni_two(d0, d1, m[5], 5));
    h2 = u64x8_xor3(h2, clib_toeplitz_hash_gfni_two(d2, d3, m[4], 4), clib_toeplitz_hash_gfni_two(d2, d3, m[5], 5));
