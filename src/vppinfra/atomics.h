...
#define clib_atomic_cmp_and_swap_acq_relax(addr, exp, new, weak) \
    __atomic_compare_exchange((addr), (exp), (new), (weak), __ATOMIC_ACQUIRE, __ATOMIC_RELAXED)
...
#define clib_atomic_store_seq_cst(a, b) __atomic_store_n((a), (b), __ATOMIC_SEQ_CST)
#define clib_atomic_store_relax_n(a, b) __atomic_store_n((a), (b), __ATOMIC_RELAXED)
