...
static inline void clib_bihash_mark_free_vec8_8(clib_bihash_kv_vec8_8_t *v)
{
...
*/
static inline int clib_bihash_is_free_vec8_8(clib_bihash_kv_vec8_8_t *v)
{
...
*/
static inline u64 clib_bihash_hash_vec8_8(clib_bihash_kv_vec8_8_t *v)
{
    u8 *keyp = (u8 *) (v->key);
...
*/
static inline u8 *format_bihash_kvp_vec8_8(u8 *s, va_list *args)
{
...
/** Compare two clib_bihash_kv_vec8_8_t instances
    ...
    @param b - second key
*/
static inline int clib_bihash_key_compare_vec8_8(u64 a_arg, u64 b_arg)
{
    u8 *a = (u8 *) a_arg;
    u8 *b = (u8 *) b_arg;

    if (a_arg == ~0ULL || b_arg == ~0ULL) return 0;
