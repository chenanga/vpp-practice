...
static u8 *format_perfmon_bundle_default(u8 *s, va_list *args)
{
...
CLIB_PERFMON_BUNDLE(default) = {
    ...
    .column_headers = CLIB_STRING_ARRAY("Freq", "IPC", "Clks", "Clks/Op", "Inst", "Inst/Op", "Brnch", "Brnch/Op", "BrMiss", "BrMiss/Op"),
};
