...
#if defined(__GNUC__)
#define COMPILER_VERSION_GTE(major, minor) (__GNUC__ > (major) || (__GNUC__ == (major) && __GNUC_MINOR__ >= (minor)))
#elif defined(__clang__)
#define COMPILER_VERSION_GTE(major, minor) (__clang_major__ > (major) || (__clang_major__ == (major) && __clang_minor__ >= (minor)))
...
#define WARN_OFF(x)    WARN_PRAGMA(push) WARN_PRAGMA(ignored "-Wpragmas") WARN_PRAGMA(push) WARN_PRAGMA(ignored WARN_TOSTR(-W##x))
#define WARN_ON(x)   \
    WARN_PRAGMA(pop) \
    WARN_PRAGMA(pop)
...
#define WARN_OFF(x)    WARN_PRAGMA(push) WARN_PRAGMA(ignored "-Wunknown-warning-option") WARN_PRAGMA(push) WARN_PRAGMA(ignored WARN_TOSTR(-W##x))
#define WARN_ON(x)   \
    WARN_PRAGMA(pop) \
    WARN_PRAGMA(pop)
#else
