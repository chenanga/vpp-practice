...
typedef void(wrapper_fn)(u32 *indices, void *base, u8 shift, void **ptrs, u32 n_elts);

__test_funct_fn void clib_index_to_ptr_u32_wrapper(u32 *indices, void *base, u8 shift, void **ptrs, u32 n_elts)
{
...
static clib_error_t *test_clib_index_to_ptr_u32(clib_error_t *err)
{
    void *_ptrs[512 + 128], **ptrs      = _ptrs + 64;
    u32   _indices[512 + 128], *indices = _indices + 64;
    u16   lengths[] = {1, 3, 5, 7, 9, 15, 16, 17, 31, 32, 33, 40, 41, 42, 63, 64, 65, 511, 512};
