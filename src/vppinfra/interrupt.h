...
static_always_inline int clib_interrupt_get_next_and_clear(void *in, int last)
{
    clib_interrupt_header_t *h = in;
    uword                    bit, v;
    uword                   *loc = h->local;
...
static_always_inline int clib_interrupt_is_any_pending(void *in)
{
    clib_interrupt_header_t *h        = in;
