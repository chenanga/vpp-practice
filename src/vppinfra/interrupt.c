...
__clib_export void clib_interrupt_init(void **data, u32 n_int)
{
...
__clib_export void clib_interrupt_resize(void **data, u32 n_int)
{
    ...
    if (n_int) h->local[n_int >> log2_uword_bits] &= pow2_mask(n_int);
}
