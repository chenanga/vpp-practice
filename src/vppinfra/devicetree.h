...
clib_dt_property_t *clib_dt_get_node_property_by_name(clib_dt_node_t *, char *);
...
static_always_inline int clib_dt_proprerty_is_u32(clib_dt_property_t *p)
{
    if (p == 0 || p->size != 4) return 0;
    return 1;
}

static_always_inline u32 clib_dt_proprerty_get_u32(clib_dt_property_t *p)
{
