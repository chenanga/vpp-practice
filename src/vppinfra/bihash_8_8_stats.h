...
static inline void clib_bihash_mark_free_8_8_stats(clib_bihash_kv_8_8_stats_t *v)
{
...
*/
static inline int clib_bihash_is_free_8_8_stats(clib_bihash_kv_8_8_stats_t *v)
{
...
*/
static inline u64 clib_bihash_hash_8_8_stats(clib_bihash_kv_8_8_stats_t *v)
{
...
*/
static inline u8 *format_bihash_kvp_8_8_stats(u8 *s, va_list *args)
{
    clib_bihash_kv_8_8_stats_t *v = va_arg(*args, clib_bihash_kv_8_8_stats_t *);
...
/** Compare two clib_bihash_kv_8_8_t instances
    ...
    @param b - second key
*/
static inline int clib_bihash_key_compare_8_8_stats(u64 a, u64 b)
{
    return a == b;
}
