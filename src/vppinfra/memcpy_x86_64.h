...
static_always_inline void clib_memcpy1(void *d, void *s)
{
    *(u8 *) d = *(u8 *) s;
}

static_always_inline void clib_memcpy2(void *d, void *s)
{
    *(u16u *) d = *(u16u *) s;
}

static_always_inline void clib_memcpy4(void *d, void *s)
{
    *(u32u *) d = *(u32u *) s;
}

static_always_inline void clib_memcpy8(void *d, void *s)
{
    *(u64u *) d = *(u64u *) s;
}

static_always_inline void clib_memcpy16(void *d, void *s)
{
...
static_always_inline void clib_memcpy32(void *d, void *s)
{
    *(u8x32u *) d = *(u8x32u *) s;
}
#endif
...
static_always_inline void clib_memcpy64(void *d, void *s)
{
    *(u8x64u *) d = *(u8x64u *) s;
}
#endif

static_always_inline void clib_memcpy_const_le32(u8 *dst, u8 *src, size_t n)
{
    switch (n) {
        case 1:
...
static_always_inline void clib_memcpy_const_le64(u8 *dst, u8 *src, size_t n)
{
    if (n < 32) {
...
static_always_inline void clib_memcpy_x86_64_const(u8 *dst, u8 *src, size_t n)
{
...
static_always_inline void *clib_memcpy_x86_64(void *restrict dst, const void *restrict src, size_t n)
{
    ...
    if (COMPILE_TIME_CONST(n)) {
        if (n) clib_memcpy_x86_64_const(d, s, n);
        return dst;
    }
    ...
    more:
        ...
        off += 512;
        if (off != final_off) goto more;

        if ((nr & 0x1ff) == 0) goto done2;
