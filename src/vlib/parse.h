...
#define _PARSE_REGISTRATION_DATA(x) VLIB_ELF_SECTION_DATA(x##_registration, parse_registration_t, parse_registrations)
...
#define _PARSE_TYPE_REGISTRATION_DATA(x) VLIB_ELF_SECTION_DATA(x##_type_registration, vlib_parse_type_t, parse_type_registrations)
