...
int evtdef_pass1(cpel_section_header_t *sh, int verbose, FILE *ofp)
{
    ...
    for (i = 0; i < nevents; i++) {
        ...
        add_event_from_cpel_file(event_code, (char *) bp->event_str, (char *) bp->datum_str);
...
int trackdef_pass1(cpel_section_header_t *sh, int verbose, FILE *ofp)
{
    ...
    for (i = 0; i < nevents; i++) {
        ...
        if (track_strlen > widest_track_format) widest_track_format = track_strlen;
        tp++;
    }
    return (0);
}
...
int event_pass2(cpel_section_header_t *sh, int verbose, FILE *ofp)
{
    ...
    for (i = 0; i < nevents; i++) {
        ...
        if (starttime == ~0ULL) starttime = now;
