...
static void test(tojson_fn_t tojson, fromjson_fn_t fromjson, cJSON *o, bool should_fail)
{
...
static void register_functions(struct msgs msgs[], int n)
{
    int i;
...
static void runtest(char *s, bool should_fail)
{
...
struct tests tests[] = {
    ...
    {.s = "{\"_msgname\": \"test_enum\", \"flags\": [\"BLACK\", \"BLUE\"]}", .should_fail = 1},
    {.s = "{\"_msgname\": \"test_string\", \"str\": {\"str\": \"Test string "
          "type\"}}"},
    {.s = "{\"_msgname\": \"test_string2\", \"str\": \"Test string toplevel\"}"},
