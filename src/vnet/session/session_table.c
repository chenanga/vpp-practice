...
session_table_t *_get_session_tables(void)
{
...
#define _(af, table, parm, value) u32 configured_##af##_##table##_table_##parm = value;
    foreach_hash_table_parameter;
#undef _

#define _(af, table, parm, value)                              \
    if (session_main.configured_##af##_##table##_table_##parm) \
        configured_##af##_##table##_table_##parm = session_main.configured_##af##_##table##_table_##parm;
    foreach_hash_table_parameter;
#undef _
...
void ip4_session_table_walk(clib_bihash_16_8_t *hash, ip4_session_table_walk_fn_t fn, void *arg)
{
    ...
    clib_bihash_foreach_key_value_pair_16_8(hash, ip4_session_table_walk_cb, &ctx);
}
