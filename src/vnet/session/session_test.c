...
static int api_session_rule_add_del(vat_main_t *vam)
{
...
static int api_app_attach(vat_main_t *vat)
{
    return -1;
}

static int api_application_detach(vat_main_t *vat)
{
    return -1;
}

static int api_app_del_cert_key_pair(vat_main_t *vat)
{
    return -1;
}

static int api_app_add_cert_key_pair(vat_main_t *vat)
{
    return -1;
}

static int api_session_rules_dump(vat_main_t *vam)
{
...
static void vl_api_session_rules_details_t_handler(vl_api_session_rules_details_t *mp)
{
...
static void vl_api_app_namespace_add_del_reply_t_handler(vl_api_app_namespace_add_del_reply_t *mp)
{
    vat_main_t *vam    = &vat_main;
    ...
    if (vam->async_mode) {
        ...
        vam->retval = retval;
        if (retval == 0) errmsg("app ns index %d\n", ntohl(mp->appns_index));
        vam->result_ready = 1;
    }
}

static void vl_api_app_namespace_add_del_v2_reply_t_handler(vl_api_app_namespace_add_del_v2_reply_t *vat)
{
}

static void vl_api_app_worker_add_del_reply_t_handler(vl_api_app_worker_add_del_reply_t *vat)
{
}

static int api_app_namespace_add_del_v2(vat_main_t *vat)
{
    return -1;
}

static int api_session_enable_disable(vat_main_t *vat)
{
    return -1;
}

static int api_session_enable_disable_v2(vat_main_t *vat)
{
    return -1;
}

static int api_app_worker_add_del(vat_main_t *vat)
{
    return -1;
}

static int api_app_namespace_add_del(vat_main_t *vam)
{
...
static void vl_api_app_namespace_add_del_v4_reply_t_handler(vl_api_app_namespace_add_del_v4_reply_t *mp)
{
}

static int api_app_namespace_add_del_v4(vat_main_t *vat)
{
    return -1;
}

static void vl_api_app_namespace_add_del_v3_reply_t_handler(vl_api_app_namespace_add_del_v3_reply_t *mp)
{
}

static int api_app_namespace_add_del_v3(vat_main_t *vat)
{
    return -1;
}

static int api_session_sapi_enable_disable(vat_main_t *vat)
{
    return -1;
}

static int api_session_sdl_add_del(vat_main_t *vam)
{
    return -1;
}

static void vl_api_session_sdl_details_t_handler(vl_api_session_rules_details_t *mp)
{
}

static int api_session_sdl_dump(vat_main_t *vam)
{
    return -1;
}
