...
#define _(sym, str) TRANSPORT_CONNECTION_F_##sym = 1 << TRANSPORT_CONNECTION_F_BIT_##sym,
    foreach_transport_connection_flag
#undef _
...
STATIC_ASSERT(STRUCT_OFFSET_OF(transport_connection_t, s_index) == TRANSPORT_CONN_ID_LEN, "update conn id len");
