...
extern void throttle_init(throttle_t *t, u32 n_threads, u32 buckets, f64 time);

always_inline u64 throttle_seed(throttle_t *t, u32 thread_index, f64 time_now)
{
...
always_inline int throttle_check(throttle_t *t, u32 thread_index, u64 hash, u64 seed)
{
