...
#define QOS_SOURCE_NAMES                                                                                          \
    {                                                                                                             \
        [QOS_SOURCE_EXT] = "ext", [QOS_SOURCE_IP] = "IP", [QOS_SOURCE_MPLS] = "MPLS", [QOS_SOURCE_VLAN] = "VLAN", \
    }

#define FOR_EACH_QOS_SOURCE(_src) for (_src = QOS_SOURCE_EXT; _src <= QOS_SOURCE_IP; _src++)
