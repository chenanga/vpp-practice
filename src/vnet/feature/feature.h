...
#define VNET_FEATURE_ARC_INIT(x, ...)                                                                                           \
    ...
    static void                                 __vnet_add_feature_arc_registration_##x(void) __attribute__((__constructor__)); \
    ...
    static void __vnet_rm_feature_arc_registration_##x(void) __attribute__((__destructor__));                                   \
...
#define VNET_FEATURE_INIT(x, ...)                                                                                       \
    ...
    static void                             __vnet_add_feature_registration_##x(void) __attribute__((__constructor__)); \
    ...
    static void __vnet_rm_feature_registration_##x(void) __attribute__((__destructor__));                               \
...
#define VNET_FEATURE_ARC_ORDER(x, ...)                                                                                                \
    ...
    static void                                        __vnet_add_constraint_registration_##x(void) __attribute__((__constructor__)); \
    ...
    static void __vnet_rm_constraint_registration_##x(void) __attribute__((__destructor__));                                          \
...
#define VNET_FEATURE_ARC_ORDER(x, ...)                                                       \
    extern vnet_feature_constraint_registration_t __clib_unused vnet_feature_constraint_##x; \
    static vnet_feature_constraint_registration_t __clib_unused __clib_unused_vnet_feature_constraint_##x
...
static_always_inline void *vnet_feature_arc_start_with_data(u8 arc, u32 sw_if_index, u32 *next, vlib_buffer_t *b, u32 n_data_bytes)
{
    ...
    if (PREDICT_FALSE(vnet_have_features(arc, sw_if_index))) {
        ...
        b->current_config_index           = vec_elt(cm->config_index_by_sw_if_index, sw_if_index);
...
static_always_inline void *vnet_feature_arc_start_w_cfg_index(u8 arc, u32 sw_if_index, u32 *next, vlib_buffer_t *b, u32 cfg_index)
{
    ...
    return vnet_get_config_data(&cm->config_main, &b->current_config_index, next, 0);
}
...
static_always_inline void vnet_feature_start_device_input(u32 sw_if_index, u32 *next0, vlib_buffer_t *b0)
{
    vnet_feature_main_t        *fm = &feature_main;
    vnet_feature_config_main_t *cm;
    ...
    if (PREDICT_FALSE(clib_bitmap_get(fm->sw_if_index_has_features[feature_arc_index], sw_if_index))) {
        vnet_buffer(b0)->feature_arc_index = feature_arc_index;
        b0->current_config_index           = vec_elt(cm->config_index_by_sw_if_index, sw_if_index);
        vnet_get_config_data(&cm->config_main, &b0->current_config_index, next0, /* # bytes of config data */ 0);
    }
}
