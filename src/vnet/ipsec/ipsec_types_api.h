...
extern int                  ipsec_proto_decode(vl_api_ipsec_proto_t in, ipsec_protocol_t* out);
extern vl_api_ipsec_proto_t ipsec_proto_encode(ipsec_protocol_t p);

extern int                       ipsec_crypto_algo_decode(vl_api_ipsec_crypto_alg_t in, ipsec_crypto_alg_t* out);
extern vl_api_ipsec_crypto_alg_t ipsec_crypto_algo_encode(ipsec_crypto_alg_t c);

extern int                      ipsec_integ_algo_decode(vl_api_ipsec_integ_alg_t in, ipsec_integ_alg_t* out);
...
extern vl_api_ipsec_sad_flags_t ipsec_sad_flags_encode(const ipsec_sa_t* sa);
