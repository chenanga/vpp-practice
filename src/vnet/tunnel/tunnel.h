...
extern uword unformat_tunnel_encap_decap_flags(unformat_input_t *input, va_list *args);
...
extern int  tunnel_resolve(tunnel_t *t, fib_node_type_t child_type, index_t child_index);
...
extern void tunnel_build_v6_hdr(const tunnel_t *t, ip_protocol_t next_proto, ip6_header_t *ip);
extern void tunnel_build_v4_hdr(const tunnel_t *t, ip_protocol_t next_proto, ip4_header_t *ip);
