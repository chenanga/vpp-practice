 ...
 */
extern int                               tunnel_encap_decap_flags_decode(vl_api_tunnel_encap_decap_flags_t _f, tunnel_encap_decap_flags_t *out);
extern vl_api_tunnel_encap_decap_flags_t tunnel_encap_decap_flags_encode(tunnel_encap_decap_flags_t f);
