...
#define foreach_flow_entry_ip4 _fe(ip4_address_and_mask_t, src_addr) _fe(ip4_address_and_mask_t, dst_addr) _fe(ip_prot_and_mask_t, protocol)

#define foreach_flow_entry_ip6 _fe(ip6_address_and_mask_t, src_addr) _fe(ip6_address_and_mask_t, dst_addr) _fe(ip_prot_and_mask_t, protocol)
...
#define foreach_flow_entry_ip4_n_tuple foreach_flow_entry_ip4 _fe(ip_port_and_mask_t, src_port) _fe(ip_port_and_mask_t, dst_port)

#define foreach_flow_entry_ip6_n_tuple foreach_flow_entry_ip6 _fe(ip_port_and_mask_t, src_port) _fe(ip_port_and_mask_t, dst_port)

#define foreach_flow_entry_ip4_n_tuple_tagged foreach_flow_entry_ip4 _fe(ip_port_and_mask_t, src_port) _fe(ip_port_and_mask_t, dst_port)

#define foreach_flow_entry_ip6_n_tuple_tagged foreach_flow_entry_ip6 _fe(ip_port_and_mask_t, src_port) _fe(ip_port_and_mask_t, dst_port)
...
#define foreach_flow_entry_ip6_ip6 \
    foreach_flow_entry_ip6 _fe(ip6_address_and_mask_t, in_src_addr) _fe(ip6_address_and_mask_t, in_dst_addr) _fe(ip_prot_and_mask_t, in_protocol)

#define foreach_flow_entry_ip6_ip6_n_tuple foreach_flow_entry_ip6_ip6 _fe(ip_port_and_mask_t, in_src_port) _fe(ip_port_and_mask_t, in_dst_port)

#define foreach_flow_entry_ip6_ip4 \
    foreach_flow_entry_ip6 _fe(ip4_address_and_mask_t, in_src_addr) _fe(ip4_address_and_mask_t, in_dst_addr) _fe(ip_prot_and_mask_t, in_protocol)

#define foreach_flow_entry_ip6_ip4_n_tuple foreach_flow_entry_ip6_ip4 _fe(ip_port_and_mask_t, in_src_port) _fe(ip_port_and_mask_t, in_dst_port)

#define foreach_flow_entry_ip4_ip6 \
    foreach_flow_entry_ip4 _fe(ip6_address_and_mask_t, in_src_addr) _fe(ip6_address_and_mask_t, in_dst_addr) _fe(ip_prot_and_mask_t, in_protocol)

#define foreach_flow_entry_ip4_ip6_n_tuple foreach_flow_entry_ip4_ip6 _fe(ip_port_and_mask_t, in_src_port) _fe(ip_port_and_mask_t, in_dst_port)

#define foreach_flow_entry_ip4_ip4 \
    foreach_flow_entry_ip4 _fe(ip4_address_and_mask_t, in_src_addr) _fe(ip4_address_and_mask_t, in_dst_addr) _fe(ip_prot_and_mask_t, in_protocol)

#define foreach_flow_entry_ip4_ip4_n_tuple foreach_flow_entry_ip4_ip4 _fe(ip_port_and_mask_t, in_src_port) _fe(ip_port_and_mask_t, in_dst_port)
