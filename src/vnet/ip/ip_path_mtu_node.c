...
static inline uword ip_pmtu_dpo_inline(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *frame, ip_address_family_t af)
{
    ...
    while (n_left_from > 0) {
        ...
        while (n_left_from > 0 && n_left_to_next > 0) {
            ...
            if (AF_IP4 == af && error0 == IP_FRAG_ERROR_DONT_FRAGMENT_SET) {
                ...
                next0 = (error0 == IP_FRAG_ERROR_NONE ? next0 : IP_FRAG_NEXT_DROP);
            }
