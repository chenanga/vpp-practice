...
extern int                          ip_feature_location_decode(vl_api_ip_feature_location_t in, ip_feature_location_t* out);
extern vl_api_ip_feature_location_t ip_feature_location_encode(ip_feature_location_t f);

/**
 * Decode/Encode for struct/union types
 */
extern ip46_type_t ip_address_decode(const vl_api_address_t* in, ip46_address_t* out);
extern void        ip_address_decode2(const vl_api_address_t* in, ip_address_t* out);
extern void        ip_address_encode(const ip46_address_t* in, ip46_type_t type, vl_api_address_t* out);
extern void        ip_address_encode2(const ip_address_t* in, vl_api_address_t* out);

extern void ip6_address_encode(const ip6_address_t* in, vl_api_ip6_address_t out);
extern void ip6_address_decode(const vl_api_ip6_address_t in, ip6_address_t* out);
extern void ip4_address_encode(const ip4_address_t* in, vl_api_ip4_address_t out);
extern void ip4_address_decode(const vl_api_ip4_address_t in, ip4_address_t* out);
...
extern void ip_mprefix_decode(const vl_api_mprefix_t* in, mfib_prefix_t* out);
extern void ip_mprefix_encode(const mfib_prefix_t* in, vl_api_mprefix_t* out);
