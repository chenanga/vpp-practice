...
extern int  ip6_link_enable(u32 sw_if_index, const ip6_address_t *link_local_addr);
...
extern int         ip6_link_set_local_address(u32 sw_if_index, const ip6_address_t *address);
...
extern ip6_link_delegate_id_t ip6_link_delegate_register(const ip6_link_delegate_vft_t *vft);
extern index_t                ip6_link_delegate_get(u32 sw_if_index, ip6_link_delegate_id_t id);
extern bool                   ip6_link_delegate_update(u32 sw_if_index, ip6_link_delegate_id_t id, index_t ii);
extern void                   ip6_link_delegate_remove(u32 sw_if_index, ip6_link_delegate_id_t id, index_t ii);
