...
always_inline ip_interface_prefix_t *ip_get_interface_prefix(ip_lookup_main_t *lm, ip_interface_prefix_key_t *k)
{
...
#define foreach_ip_interface_address(lm, a, sw_if_index, loop, body)                                             \
    do {                                                                                                         \
        ...
        u32                     _ia = ((vec_len((lm)->if_address_pool_index_by_sw_if_index) > (_sw_if_index))    \
                                           ? vec_elt((lm)->if_address_pool_index_by_sw_if_index, (_sw_if_index)) \
                                           : (u32) ~0);                                                          \
