 ...
 */
_Static_assert((sizeof(mpls_disp_dpo_t) <= CLIB_CACHE_LINE_BYTES), "MPLS Disposition DPO is larger than one cache line.");
 ...
 */
extern void mpls_disp_dpo_create(dpo_proto_t payload_proto, fib_rpf_id_t rpf_id, fib_mpls_lsp_mode_t mode, const dpo_id_t *parent, dpo_id_t *dpo);
...
static inline mpls_disp_dpo_t *mpls_disp_dpo_get(index_t index)
{
