...
#define FOR_EACH_MPLS_LABEL_DPO_ATTR(_item) for (_item = MPLS_LABEL_DPO_ATTR_NO_IP_TTL_DECR; _item <= MPLS_LABEL_DPO_ATTR_UNIFORM_MODE; _item++)
...
static inline mpls_label_dpo_t *mpls_label_dpo_get(index_t index)
{
