...
static inline load_balance_map_t *load_balance_map_get(index_t lbmi)
{
    return (pool_elt_at_index(load_balance_map_pool, lbmi));
}

static inline u16 load_balance_map_translate(index_t lbmi, u16 bucket)
{
...
static inline const dpo_id_t *load_balance_get_fwd_bucket(const load_balance_t *lb, u16 bucket)
{
