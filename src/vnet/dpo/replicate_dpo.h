...
STATIC_ASSERT(REP_MAX_BUCKETS <= CLIB_U16_MAX, "Too many buckets for replicate object");
...
static inline replicate_t *replicate_get(index_t repi)
{
...
static inline const dpo_id_t *replicate_get_bucket_i(const replicate_t *rep, u32 bucket)
{
