...
extern int ip6_ra_config(vlib_main_t *vm,
                         u32          sw_if_index,
                         u8           suppress,
                         u8           managed,
                         u8           other,
...
extern int ip6_ra_prefix(vlib_main_t   *vm,
                         u32            sw_if_index,
...
extern void icmp6_send_router_solicitation(vlib_main_t *vm, u32 sw_if_index, u8 stop, const icmp6_send_router_solicitation_params_t *params);
...
extern void ip6_ra_update_secondary_radv_info(ip6_address_t *address, u8 prefix_len, u32 primary_sw_if_index, u32 valid_time, u32 preferred_time);
