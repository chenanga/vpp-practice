...
vnet_dev_rv_t vnet_dev_api_attach(vlib_main_t *, vnet_dev_api_attach_args_t *);

typedef struct {
    u32 dev_index;
} vnet_dev_api_detach_args_t;
vnet_dev_rv_t vnet_dev_api_detach(vlib_main_t *, vnet_dev_api_detach_args_t *);
...
vnet_dev_rv_t vnet_dev_api_create_port_if(vlib_main_t *, vnet_dev_api_create_port_if_args_t *);

typedef struct {
    u32 sw_if_index;
} vnet_dev_api_remove_port_if_args_t;

vnet_dev_rv_t vnet_dev_api_remove_port_if(vlib_main_t *, vnet_dev_api_remove_port_if_args_t *);
