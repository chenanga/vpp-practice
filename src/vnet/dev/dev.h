...
typedef vnet_dev_rv_t(vnet_dev_port_cfg_change_op_t)(vlib_main_t *, vnet_dev_port_t *, vnet_dev_port_cfg_change_req_t *);
typedef vnet_dev_rv_t(vnet_dev_rx_queue_op_t)(vlib_main_t *, vnet_dev_rx_queue_t *);
typedef vnet_dev_rv_t(vnet_dev_tx_queue_op_t)(vlib_main_t *, vnet_dev_tx_queue_t *);
typedef void(vnet_dev_op_no_rv_t)(vlib_main_t *, vnet_dev_t *);
typedef void(vnet_dev_port_op_no_rv_t)(vlib_main_t *, vnet_dev_port_t *);
typedef void(vnet_dev_rx_queue_op_no_rv_t)(vlib_main_t *, vnet_dev_rx_queue_t *);
typedef void(vnet_dev_tx_queue_op_no_rv_t)(vlib_main_t *, vnet_dev_tx_queue_t *);
...
typedef struct {
    ...
    vnet_dev_rv_t (*dma_mem_alloc_fn)(vlib_main_t *, vnet_dev_t *, u32, u32, void **);
...
/* args.c */
vnet_dev_rv_t     vnet_dev_arg_parse(vlib_main_t *, vnet_dev_t *, vnet_dev_arg_t *, u8 *);
...
/* dev.c */
vnet_dev_t     *vnet_dev_alloc(vlib_main_t *, vnet_dev_device_id_t, vnet_dev_driver_t *);
...
vnet_dev_rv_t   vnet_dev_port_add(vlib_main_t *, vnet_dev_t *, vnet_dev_port_id_t, vnet_dev_port_add_args_t *);
vnet_dev_rv_t   vnet_dev_dma_mem_alloc(vlib_main_t *, vnet_dev_t *, u32, u32, void **);
...
/* error.c */
clib_error_t *vnet_dev_port_err(vlib_main_t *, vnet_dev_port_t *, vnet_dev_rv_t, char *, ...);
...
clib_error_t *vnet_dev_port_mac_change(vnet_hw_interface_t *, const u8 *, const u8 *);
clib_error_t *vnet_dev_add_del_mac_address(vnet_hw_interface_t *, const u8 *, u8);
int           vnet_dev_flow_ops_fn(vnet_main_t *, vnet_flow_dev_op_t, u32, u32, uword *);
clib_error_t *vnet_dev_interface_set_rss_queues(vnet_main_t *, vnet_hw_interface_t *, clib_bitmap_t *);
...
vnet_dev_rv_t vnet_dev_port_start_all_rx_queues(vlib_main_t *, vnet_dev_port_t *);
vnet_dev_rv_t vnet_dev_port_start_all_tx_queues(vlib_main_t *, vnet_dev_port_t *);
...
void          vnet_dev_port_add_counters(vlib_main_t *, vnet_dev_port_t *, vnet_dev_counter_t *, u16);
...
void          vnet_dev_port_state_change(vlib_main_t *, vnet_dev_port_t *, vnet_dev_port_state_changes_t);
void          vnet_dev_port_clear_counters(vlib_main_t *, vnet_dev_port_t *);
vnet_dev_rv_t vnet_dev_port_cfg_change_req_validate(vlib_main_t *, vnet_dev_port_t *, vnet_dev_port_cfg_change_req_t *);
vnet_dev_rv_t vnet_dev_port_cfg_change(vlib_main_t *, vnet_dev_port_t *, vnet_dev_port_cfg_change_req_t *);
...
void          vnet_dev_rx_queue_add_counters(vlib_main_t *, vnet_dev_rx_queue_t *, vnet_dev_counter_t *, u16);
void          vnet_dev_rx_queue_free_counters(vlib_main_t *, vnet_dev_rx_queue_t *);
void          vnet_dev_tx_queue_add_counters(vlib_main_t *, vnet_dev_tx_queue_t *, vnet_dev_counter_t *, u16);
...
vnet_dev_rv_t vnet_dev_process_call_op(vlib_main_t *, vnet_dev_t *, vnet_dev_op_t *);
vnet_dev_rv_t vnet_dev_process_call_op_no_rv(vlib_main_t *, vnet_dev_t *, vnet_dev_op_no_rv_t *);
void          vnet_dev_process_call_op_no_wait(vlib_main_t *, vnet_dev_t *, vnet_dev_op_no_rv_t *);
vnet_dev_rv_t vnet_dev_process_call_port_op(vlib_main_t *, vnet_dev_port_t *, vnet_dev_port_op_t *);
vnet_dev_rv_t vnet_dev_process_call_port_op_no_rv(vlib_main_t *vm, vnet_dev_port_t *, vnet_dev_port_op_no_rv_t *);
void          vnet_dev_process_call_port_op_no_wait(vlib_main_t *, vnet_dev_port_t *, vnet_dev_port_op_no_rv_t *);
vnet_dev_rv_t vnet_dev_process_port_cfg_change_req(vlib_main_t *, vnet_dev_port_t *, vnet_dev_port_cfg_change_req_t *);
void          vnet_dev_process_quit(vlib_main_t *, vnet_dev_t *);
void          vnet_dev_poll_dev_add(vlib_main_t *, vnet_dev_t *, f64, vnet_dev_op_no_rv_t *);
void          vnet_dev_poll_dev_remove(vlib_main_t *, vnet_dev_t *, vnet_dev_op_no_rv_t *);
void          vnet_dev_poll_port_add(vlib_main_t *, vnet_dev_port_t *, f64, vnet_dev_port_op_no_rv_t *);
void          vnet_dev_poll_port_remove(vlib_main_t *, vnet_dev_port_t *, vnet_dev_port_op_no_rv_t *);
...
vnet_dev_rv_t vnet_dev_rt_exec_ops(vlib_main_t *, vnet_dev_t *, vnet_dev_rt_op_t *, u32);
...
STATIC_ASSERT(sizeof(vnet_dev_rx_node_runtime_t) <= VLIB_NODE_RUNTIME_DATA_SIZE, "must fit into runtime data");
...
STATIC_ASSERT(sizeof(vnet_dev_tx_node_runtime_t) <= VLIB_NODE_RUNTIME_DATA_SIZE, "must fit into runtime data");
...
#define VNET_DEV_REGISTER_BUS(x, ...)                                                         \
    ...
    {                                                                                         \
        ...
        __vnet_dev_bus_registration_##x.next_registration = dm->bus_registrations;            \
...
#define VNET_DEV_REGISTER_DRIVER(x, ...)                                                            \
    ...
    {                                                                                               \
        vnet_dev_main_t *dm                                  = &vnet_dev_main;                      \
        __vnet_dev_driver_registration_##x.next_registration = dm->driver_registrations;            \
        dm->driver_registrations                             = &__vnet_dev_driver_registration_##x; \
    }                                                                                               \
    __VA_ARGS__ vnet_dev_driver_registration_t __vnet_dev_driver_registration_##x

#define VNET_DEV_NODE_FN(node)                                                                                          \
    uword                              CLIB_MARCH_SFX(node##_fn)(vlib_main_t *, vlib_node_runtime_t *, vlib_frame_t *); \
    static vlib_node_fn_registration_t CLIB_MARCH_SFX(node##_fn_registration) = {                                       \
        .function = &CLIB_MARCH_SFX(node##_fn),                                                                         \
    };                                                                                                                  \
                                                                                                                        \
    static void __clib_constructor CLIB_MARCH_SFX(node##_fn_multiarch_register)(void)                                   \
    {                                                                                                                   \
...
#define foreach_vnet_dev_port_rx_queue(q, p) pool_foreach_pointer (q, p->rx_queues)
#define foreach_vnet_dev_port_tx_queue(q, p) pool_foreach_pointer (q, p->tx_queues)
