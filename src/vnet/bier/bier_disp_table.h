...
extern void bier_disp_table_entry_path_add(u32 table_id, bier_bp_t src, bier_hdr_proto_id_t payload_proto, const fib_route_path_t *rpath);

extern void bier_disp_table_entry_path_remove(u32 table_id, bier_bp_t src, bier_hdr_proto_id_t payload_proto, const fib_route_path_t *paths);
...
extern void bier_disp_table_contribute_forwarding(index_t bdti, dpo_id_t *dpo);
...
extern void bier_disp_table_walk(u32 table_id, bier_disp_table_walk_fn_t fn, void *ctx);
...
static inline bier_disp_table_t *bier_disp_table_get(index_t bdti)
{
    return (pool_elt_at_index(bier_disp_table_pool, bdti));
}

static inline index_t bier_disp_table_lookup(index_t bdti, bier_hdr_src_id_t src)
{
