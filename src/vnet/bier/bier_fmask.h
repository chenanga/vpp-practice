...
#define BIER_FMASK_ATTR_NAMES                                                                                                 \
    {                                                                                                                         \
        [BIER_FMASK_ATTR_FORWARDING] = "forwarding", [BIER_FMASK_ATTR_DISP] = "disposition", [BIER_FMASK_ATTR_MPLS] = "mpls", \
    }
...
extern u32  bier_fmask_child_add(fib_node_index_t fib_entry_index, fib_node_type_t child_type, fib_node_index_t child_index);
...
extern void bier_fmask_encode(index_t bfmi, bier_table_id_t *btid, fib_route_path_t *rpath);
