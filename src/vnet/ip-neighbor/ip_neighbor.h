...
extern int            ip_neighbor_add(const ip_address_t *ip, const mac_address_t *mac, u32 sw_if_index, ip_neighbor_flags_t flags, u32 *stats_index);
extern int            ip_neighbor_del(const ip_address_t *ip, u32 sw_if_index);

extern int ip_neighbor_config(ip_address_family_t af, u32 limit, u32 age, bool recycle);
extern int ip_neighbor_get_config(ip_address_family_t af, u32 *limit, u32 *age, bool *recycle);
...
extern void ip_neighbor_walk(ip_address_family_t af, u32 sw_if_index, ip_neighbor_walk_cb_t fn, void *ctx);
...
extern void ip_neighbor_probe_dst(u32 sw_if_index, u32 thread_index, ip_address_family_t af, const ip46_address_t *ip);
 ...
 */
extern int ip4_neighbor_proxy_add(u32 fib_index, const ip4_address_t *start, const ip4_address_t *end);
extern int ip4_neighbor_proxy_delete(u32 fib_index, const ip4_address_t *start, const ip4_address_t *end);
extern int ip4_neighbor_proxy_enable(u32 sw_if_index);
extern int ip4_neighbor_proxy_disable(u32 sw_if_index);
extern int ip6_neighbor_proxy_add(u32 sw_if_index, const ip6_address_t *addr);
extern int ip6_neighbor_proxy_del(u32 sw_if_index, const ip6_address_t *addr);
...
extern void ip_neighbor_register(ip_address_family_t af, const ip_neighbor_vft_t *vft);
