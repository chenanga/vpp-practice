...
#define FOREACH_IP_NEIGHBOR_CTR(_type) for (_type = 0; _type < N_IP_NEIGHBOR_CTRS; _type++)
...
extern void ip_neighbor_alloc_ctr(ip_neighbor_counters_t *ctr, u32 sw_if_index);
