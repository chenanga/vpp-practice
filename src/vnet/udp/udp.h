...
always_inline udp_worker_t *udp_worker_get(u32 thread_index)
{
    return vec_elt_at_index(udp_main.wrk, thread_index);
}

always_inline udp_connection_t *udp_connection_get(u32 conn_index, u32 thread_index)
{
...
always_inline udp_connection_t *udp_listener_get(u32 conn_index)
{
    return pool_elt_at_index(udp_main.listener_pool, conn_index);
}

always_inline udp_main_t *vnet_get_udp_main()
{
    return &udp_main;
}

always_inline udp_connection_t *udp_connection_from_transport(transport_connection_t *tc)
{
...
always_inline udp_connection_t *udp_connection_clone_safe(u32 connection_index, u32 thread_index)
{
