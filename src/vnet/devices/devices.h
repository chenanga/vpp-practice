...
#define VNET_DEVICE_INPUT_NEXT_NODES                                                                                        \
    {                                                                                                                       \
        [VNET_DEVICE_INPUT_NEXT_DROP] = "error-drop", [VNET_DEVICE_INPUT_NEXT_ETHERNET_INPUT] = "ethernet-input",           \
        [VNET_DEVICE_INPUT_NEXT_IP4_NCS_INPUT] = "ip4-input-no-checksum", [VNET_DEVICE_INPUT_NEXT_IP4_INPUT] = "ip4-input", \
        [VNET_DEVICE_INPUT_NEXT_IP6_INPUT] = "ip6-input", [VNET_DEVICE_INPUT_NEXT_MPLS_INPUT] = "mpls-input",               \
        [VNET_DEVICE_INPUT_NEXT_IP4_DROP] = "ip4-drop", [VNET_DEVICE_INPUT_NEXT_IP6_DROP] = "ip6-drop",                     \
...
static inline void vnet_device_increment_rx_packets(u32 thread_index, u64 count)
{
    vnet_device_main_t            *vdm = &vnet_device_main;
    vnet_device_per_worker_data_t *pwd;
