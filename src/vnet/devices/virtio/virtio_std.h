...
#define foreach_virtio_net_features                                                                      \
    ...
    _(VIRTIO_RING_F_EVENT_IDX, 29)     /* The Guest publishes the used index for which it expects an     \
    ...
    _(VIRTIO_NET_F_HASH_REPORT, 57)  /* Device supports per packet hash value */                         \
