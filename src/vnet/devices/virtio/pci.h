...
typedef enum { VIRTIO_MSIX_NONE = 0, VIRTIO_MSIX_DISABLED = 1, VIRTIO_MSIX_ENABLED = 2 } virtio_msix_status_t;
...
#define VIRTIO_NET_HASH_TYPE_SUPPORTED                                                                                                            \
    (VIRTIO_NET_HASH_TYPE_IPV4 | VIRTIO_NET_HASH_TYPE_TCPV4 | VIRTIO_NET_HASH_TYPE_UDPV4 | VIRTIO_NET_HASH_TYPE_IPV6 | VIRTIO_NET_HASH_TYPE_TCPV6 \
     | VIRTIO_NET_HASH_TYPE_UDPV6 | VIRTIO_NET_HASH_TYPE_IPV6_EX | VIRTIO_NET_HASH_TYPE_TCPV6_EX | VIRTIO_NET_HASH_TYPE_UDPV6_EX)
...
typedef struct _virtio_pci_func {
    void (*read_config)(vlib_main_t *vm, virtio_if_t *vif, void *dst, int len, u32 addr);
    void (*write_config)(vlib_main_t *vm, virtio_if_t *vif, void *src, int len, u32 addr);

    u64 (*get_device_features)(vlib_main_t *vm, virtio_if_t *vif);
    u64 (*get_driver_features)(vlib_main_t *vm, virtio_if_t *vif);
    void (*set_driver_features)(vlib_main_t *vm, virtio_if_t *vif, u64 features);
    ...
    void (*set_queue_size)(vlib_main_t *vm, virtio_if_t *vif, u16 queue_id, u16 queue_size);
    u8 (*setup_queue)(vlib_main_t *vm, virtio_if_t *vif, u16 queue_id, vnet_virtio_vring_t *vring);
    void (*del_queue)(vlib_main_t *vm, virtio_if_t *vif, u16 queue_id);
    u16 (*get_queue_notify_off)(vlib_main_t *vm, virtio_if_t *vif, u16 queue_id);
    void (*notify_queue)(vlib_main_t *vm, virtio_if_t *vif, u16 queue_id, u16 queue_notify_offset);

    u16 (*set_config_irq)(vlib_main_t *vm, virtio_if_t *vif, u16 vec);
    u16 (*set_queue_irq)(vlib_main_t *vm, virtio_if_t *vif, u16 vec, u16 queue_id);
