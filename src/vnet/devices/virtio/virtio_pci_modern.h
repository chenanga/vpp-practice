...
#define _(t)                                                                     \
    static_always_inline t virtio_pci_reg_read_##t(virtio_if_t *vif, u32 offset) \
    {                                                                            \
        t val;                                                                   \
...
#define _(t)                                                                                \
    static_always_inline void virtio_pci_reg_write_##t(virtio_if_t *vif, u32 offset, t val) \
    {                                                                                       \
