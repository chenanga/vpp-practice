...
#define FOR_EACH_MPLS_TUNNEL_ATTRIBUTE(_item) for (_item = MPLS_TUNNEL_ATTRIBUTE_FIRST; _item <= MPLS_TUNNEL_ATTRIBUTE_LAST; _item++)
 ...
 */
extern u32 vnet_mpls_tunnel_create(u8 l2_only, u8 is_multicast, u8 *description);
