...
(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *frame)
{
    ...
    while (n_left_from > 0) {
        ...
        while (n_left_from >= 8 && n_left_to_next >= 4) {
            ...
            bdc0 = vec_elt_at_index(l2input_main.bd_configs, vnet_buffer(b0)->l2.bd_index);
            bdc1 = vec_elt_at_index(l2input_main.bd_configs, vnet_buffer(b1)->l2.bd_index);
            bdc2 = vec_elt_at_index(l2input_main.bd_configs, vnet_buffer(b2)->l2.bd_index);
            bdc3 = vec_elt_at_index(l2input_main.bd_configs, vnet_buffer(b3)->l2.bd_index);
    ...
    vlib_node_increment_counter(vm, node->node_index, L2_UU_FWD_ERROR_L2_UU_FWD, frame->n_vectors);
