...
extern int sr_localsid_register_function(vlib_main_t          *vm,
                                         u8                   *fn_name,
                                         u8                   *keyword_str,
                                         u8                   *def_str,
                                         u8                   *params_str,
...
extern int sr_policy_register_function(vlib_main_t            *vm,
                                       u8                     *fn_name,
                                       u8                     *keyword_str,
                                       u8                     *def_str,
                                       u8                     *params_str,
...
extern int sr_policy_add(ip6_address_t *bsid,
                         ...
                         u16            plugin,
                         void          *plugin_mem);
extern int sr_policy_mod(ip6_address_t *bsid,
                         u32            index,
                         u32            fib_table,
                         u8             operation,
                         ip6_address_t *segments,
...
extern int sr_cli_localsid(char            is_del,
...
extern int sr_steering_policy(int             is_del,
                              ip6_address_t  *bsid,
                              u32             sr_policy_index,
                              u32             table_id,
 ...
 */
static inline u8 *ip6_sr_compute_rewrite_string_insert(ip6_address_t *sl)
{
    ip6_sr_header_t *srh;
