...
static_always_inline u32 compute_ip6_key(ip6_header_t *ip)
{
    u32 hash = 0, l4hdr;
    u8  pr;
    /* dst + src ip as u64 */
...
static_always_inline u32 compute_ip4_key(ip4_header_t *ip)
{
    u32 hash = 0, l4hdr;
    u8  pr;
    /* dst + src ip as u64 */
...
static_always_inline u32 compute_ip_key(void *p)
{
    if ((((u8 *) p)[0] & 0xf0) == 0x40)
...
static_always_inline u32 compute_ethernet_key(void *p)
{
